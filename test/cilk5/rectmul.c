...
int run(long x, long y, long z, int check, int round) {
...
const char *specifiers[] = { "-x", "-y", "-z", "-c", "-benchmark", "-h", "-r",  0};
int opt_types[] = {INTARG, INTARG, INTARG, BOOLARG, BENCHMARK, BOOLARG, INTARG, 0 };


int main(int argc, char *argv[]) {

  int x, y, z, benchmark, help, t, check, round;
  ...
  get_options(argc, argv, specifiers, opt_types, 
              &x, &y, &z, &check, &benchmark, &help, &round);
