...
if.then:                                          ; preds = %entry
  ...
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str, i64 0, i64 0), i64 50, i64 1, %struct._IO_FILE* %0) #12, !dbg !124
  tail call void @exit(i32 noundef 1) #13, !dbg !125
  unreachable, !dbg !125
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.dbg.value(metadata i8* %2, metadata !128, metadata !DIExpression()) #14, !dbg !136
  %call.i = tail call i64 @strtol(i8* nocapture noundef nonnull %2, i8** noundef null, i32 noundef 10) #14, !dbg !138
  ...
  call void @llvm.dbg.value(metadata i8* %3, metadata !128, metadata !DIExpression()) #14, !dbg !141
  %call.i20 = tail call i64 @strtol(i8* nocapture noundef nonnull %3, i8** noundef null, i32 noundef 10) #14, !dbg !143
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %4) #14, !dbg !149
  call void @llvm.dbg.declare(metadata %struct.timeval* %t1, metadata !111, metadata !DIExpression()), !dbg !150
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %5) #14, !dbg !149
  call void @llvm.dbg.declare(metadata %struct.timeval* %t2, metadata !114, metadata !DIExpression()), !dbg !151
  %call5 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #14, !dbg !152
  ...
  %call7 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #14, !dbg !154
  ...
  %call12 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %10, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), i32 noundef %call6) #12, !dbg !171
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %5) #14, !dbg !172
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %4) #14, !dbg !172
