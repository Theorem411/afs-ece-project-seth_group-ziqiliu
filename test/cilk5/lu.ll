...
pfor.body.entry:                                  ; preds = %pfor.cond
  ...
  %call = tail call double @sin(double noundef %g.0.g.0.g.0.) #18, !dbg !83
  call void @llvm.dbg.value(metadata double %g.0.g.0.g.0., metadata !64, metadata !DIExpression()), !dbg !72
...
for.cond1.preheader.i:                            ; preds = %entry, %for.inc12.i
  %indvars.iv26.i = phi i64 [ %indvars.iv.next27.i, %for.inc12.i ], [ 0, %entry ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv26.i, metadata !118, metadata !DIExpression()) #18, !dbg !130
  call void @llvm.dbg.value(metadata i32 0, metadata !129, metadata !DIExpression()) #18, !dbg !130
...
for.body3.i:                                      ; preds = %for.body3.i, %for.cond1.preheader.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i, metadata !129, metadata !DIExpression()) #18, !dbg !130
  ...
  call void @llvm.dbg.value(metadata double %16, metadata !141, metadata !DIExpression()) #18, !dbg !152
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %W, i64 %indvars.iv.i), metadata !142, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %M, i64 %indvars.iv26.i), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i32 16, metadata !144, metadata !DIExpression()) #18, !dbg !152
  call void @llvm.dbg.value(metadata i32 16, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i32 16, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i32 16, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %18 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %17, double %15) #18, !dbg !133
  store double %18, double* %arrayidx2.i.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 15, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 15, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %20 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %19, double %14) #18, !dbg !133
  store double %20, double* %arrayidx2.i.1.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 14, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 14, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %22 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %21, double %13) #18, !dbg !133
  store double %22, double* %arrayidx2.i.2.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 13, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 13, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %24 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %23, double %12) #18, !dbg !133
  store double %24, double* %arrayidx2.i.3.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 12, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 12, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %26 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %25, double %11) #18, !dbg !133
  store double %26, double* %arrayidx2.i.4.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 11, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 11, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %28 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %27, double %10) #18, !dbg !133
  store double %28, double* %arrayidx2.i.5.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 10, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 10, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %30 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %29, double %9) #18, !dbg !133
  store double %30, double* %arrayidx2.i.6.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 9, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 9, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %32 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %31, double %8) #18, !dbg !133
  store double %32, double* %arrayidx2.i.7.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 8, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 8, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %34 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %33, double %7) #18, !dbg !133
  store double %34, double* %arrayidx2.i.8.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 7, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 7, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %36 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %35, double %6) #18, !dbg !133
  store double %36, double* %arrayidx2.i.9.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 6, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 6, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %38 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %37, double %5) #18, !dbg !133
  store double %38, double* %arrayidx2.i.10.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 5, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 5, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %40 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %39, double %4) #18, !dbg !133
  store double %40, double* %arrayidx2.i.11.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 4, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 4, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %42 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %41, double %3) #18, !dbg !133
  store double %42, double* %arrayidx2.i.12.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 3, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 3, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %44 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %43, double %2) #18, !dbg !133
  store double %44, double* %arrayidx2.i.13.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 2, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 2, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %46 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %45, double %1) #18, !dbg !133
  store double %46, double* %arrayidx2.i.14.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  ...
  %48 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %47, double %0) #18, !dbg !133
  store double %48, double* %arrayidx2.i.15.phi.trans.insert.i, align 8, !dbg !133, !tbaa !75
  call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !152
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !154
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i, metadata !129, metadata !DIExpression()) #18, !dbg !130
...
for.inc12.i:                                      ; preds = %for.body3.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next27.i, metadata !118, metadata !DIExpression()) #18, !dbg !130
...
det.cont48.tf:                                    ; preds = %det.cont.tf, %det.achd47
...
det.cont52.tf:                                    ; preds = %sync.continue.tf, %det.achd51
...
det.cont54.tf:                                    ; preds = %det.cont52.tf, %det.achd53
...
cleanup:                                          ; preds = %for.inc12.i, %det.cont56
  ret void, !dbg !187
}
...
entry:
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %Ma, metadata !203, metadata !DIExpression()) #18, !dbg !198
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %L, metadata !204, metadata !DIExpression()) #18, !dbg !198
  call void @llvm.dbg.value(metadata i32 %nb, metadata !205, metadata !DIExpression()) #18, !dbg !198
  %cmp.i = icmp eq i32 %nb, 1, !dbg !216
  br i1 %cmp.i, label %if.then.i32, label %if.end.i, !dbg !218

if.end.i:                                         ; preds = %entry
  %div.i = sdiv i32 %nb, 2, !dbg !219
  call void @llvm.dbg.value(metadata i32 %div.i, metadata !210, metadata !DIExpression()) #18, !dbg !198
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %Ma, metadata !206, metadata !DIExpression()) #18, !dbg !198
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx5.i, metadata !207, metadata !DIExpression()) #18, !dbg !198
  %mul6.i = mul nsw i32 %0, %div.i, !dbg !221
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Ma, i32 %mul6.i), metadata !208, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_LLVM_convert, 32, DW_ATE_signed, DW_OP_LLVM_convert, 64, DW_ATE_signed, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !198
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx13.i, metadata !209, metadata !DIExpression()) #18, !dbg !198
...
det.achd.i:                                       ; preds = %if.end.i
  ...
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Ma, i64 %idxprom8.i), metadata !208, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !198
  %arrayidx9.i = getelementptr inbounds [16 x [16 x double]], [16 x [16 x double]]* %Ma, i64 %idxprom8.i, !dbg !221
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx9.i, metadata !208, metadata !DIExpression()) #18, !dbg !198
  tail call void @aux_lower_solve([16 x [16 x double]]* noundef %Ma, [16 x [16 x double]]* noundef %arrayidx9.i, [16 x [16 x double]]* noundef %L, i32 noundef %div.i) #18, !dbg !223
  reattach within %syncreg.i, label %det.cont.i, !dbg !223

det.cont.i:                                       ; preds = %det.achd.i, %if.end.i
  tail call void @aux_lower_solve([16 x [16 x double]]* noundef %arrayidx5.i, [16 x [16 x double]]* noundef %arrayidx13.i, [16 x [16 x double]]* noundef %L, i32 noundef %div.i) #18, !dbg !224
...
if.then.i32:                                      ; preds = %entry
  ...
  tail call fastcc void @block_lower_solve([16 x double]* noundef %arraydecay.i, [16 x double]* noundef %arraydecay1.i) #18, !dbg !229
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %Mb, metadata !203, metadata !DIExpression()) #18, !dbg !231
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx12, metadata !204, metadata !DIExpression()) #18, !dbg !231
  call void @llvm.dbg.value(metadata i32 %nb, metadata !205, metadata !DIExpression()) #18, !dbg !231
  ...
  tail call fastcc void @block_lower_solve([16 x double]* noundef %arraydecay.i30, [16 x double]* noundef %arraydecay1.i31) #18, !dbg !235
...
if.end.i40:                                       ; preds = %det.cont.i
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx12, metadata !204, metadata !DIExpression()) #18, !dbg !231
  call void @llvm.dbg.value(metadata i32 %nb, metadata !205, metadata !DIExpression()) #18, !dbg !231
  call void @llvm.dbg.value(metadata i32 %div.i, metadata !210, metadata !DIExpression()) #18, !dbg !231
  %1 = load i32, i32* @nBlocks, align 4, !dbg !237, !tbaa !166
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %Mb, metadata !206, metadata !DIExpression()) #18, !dbg !231
  %arrayidx5.i35 = getelementptr inbounds [16 x [16 x double]], [16 x [16 x double]]* %Mb, i64 %idxprom4.i, !dbg !238
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx5.i35, metadata !207, metadata !DIExpression()) #18, !dbg !231
  %mul6.i36 = mul nsw i32 %1, %div.i, !dbg !239
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Mb, i32 %mul6.i36), metadata !208, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_LLVM_convert, 32, DW_ATE_signed, DW_OP_LLVM_convert, 64, DW_ATE_signed, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !231
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx13.i39, metadata !209, metadata !DIExpression()) #18, !dbg !231
...
det.achd.i43:                                     ; preds = %if.end.i40
  ...
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Mb, i64 %idxprom8.i41), metadata !208, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !231
  %arrayidx9.i42 = getelementptr inbounds [16 x [16 x double]], [16 x [16 x double]]* %Mb, i64 %idxprom8.i41, !dbg !239
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx9.i42, metadata !208, metadata !DIExpression()) #18, !dbg !231
  tail call void @aux_lower_solve([16 x [16 x double]]* noundef %Mb, [16 x [16 x double]]* noundef %arrayidx9.i42, [16 x [16 x double]]* noundef %arrayidx12, i32 noundef %div.i) #18, !dbg !241
  reattach within %syncreg.i, label %det.cont.i44, !dbg !241

det.cont.i44:                                     ; preds = %det.achd.i43, %if.end.i40
  tail call void @aux_lower_solve([16 x [16 x double]]* noundef %arrayidx5.i35, [16 x [16 x double]]* noundef %arrayidx13.i39, [16 x [16 x double]]* noundef %arrayidx12, i32 noundef %div.i) #18, !dbg !242
...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  call void @llvm.dbg.value(metadata double %24, metadata !141, metadata !DIExpression()) #18, !dbg !279
  call void @llvm.dbg.value(metadata !DIArgList([16 x double]* %B, i64 %indvars.iv), metadata !142, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata !DIArgList([16 x double]* %B, i64 %indvars.iv28), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i32 16, metadata !144, metadata !DIExpression()) #18, !dbg !279
  call void @llvm.dbg.value(metadata i32 16, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i32 16, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i32 16, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  %neg.i = fneg double %24
  call void @llvm.dbg.value(metadata i64 15, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 15, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  ...
  call void @llvm.dbg.value(metadata i64 14, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 14, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 13, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 13, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  ...
  call void @llvm.dbg.value(metadata i64 12, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 12, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 11, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 11, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  ...
  call void @llvm.dbg.value(metadata i64 10, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 10, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 9, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 9, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  ...
  call void @llvm.dbg.value(metadata i64 8, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 8, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 7, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 7, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  ...
  call void @llvm.dbg.value(metadata i64 6, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 6, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 5, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 5, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  ...
  call void @llvm.dbg.value(metadata i64 4, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 4, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 3, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 3, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  ...
  call void @llvm.dbg.value(metadata i64 2, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 2, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  ...
  call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
  call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !279
...
entry:
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %Ma, metadata !303, metadata !DIExpression()) #18, !dbg !300
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %U, metadata !304, metadata !DIExpression()) #18, !dbg !300
  call void @llvm.dbg.value(metadata i32 %nb, metadata !305, metadata !DIExpression()) #18, !dbg !300
...
for.cond1.preheader.i:                            ; preds = %for.cond1.preheader.i.preheader, %for.inc24.i
  %indvars.iv49.i = phi i64 [ %indvars.iv.next50.i, %for.inc24.i ], [ 0, %for.cond1.preheader.i.preheader ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv49.i, metadata !326, metadata !DIExpression()) #18, !dbg !330
  call void @llvm.dbg.value(metadata i32 0, metadata !327, metadata !DIExpression()) #18, !dbg !330
  call void @llvm.dbg.value(metadata i64 0, metadata !327, metadata !DIExpression()) #18, !dbg !330
  ...
  call void @llvm.dbg.value(metadata double %div.i4877, metadata !141, metadata !DIExpression()) #18, !dbg !338
  call void @llvm.dbg.value(metadata double* %arrayidx17.i78, metadata !142, metadata !DIExpression()) #18, !dbg !338
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Ma, i64 %indvars.iv49.i), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_plus_uconst, 8, DW_OP_stack_value)) #18, !dbg !338
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 0), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !338
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 0), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !338
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 0), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !338
  br label %for.body.lr.ph.i.i, !dbg !340

for.body3.i.loopexit:                             ; preds = %for.body.i.i, %for.body.i.i.prol.loopexit
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i82, metadata !327, metadata !DIExpression()) #18, !dbg !330
  ...
  call void @llvm.dbg.value(metadata double %div.i48, metadata !141, metadata !DIExpression()) #18, !dbg !338
  call void @llvm.dbg.value(metadata double* %arrayidx17.i, metadata !142, metadata !DIExpression()) #18, !dbg !338
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Ma, i64 %indvars.iv49.i, i64 %indvars.iv.next.i), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_LLVM_arg, 2, DW_OP_constu, 8, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !338
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 %indvars.iv.next.i82), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !338
...
for.body.lr.ph.i.i:                               ; preds = %for.cond1.preheader.i, %for.body3.i.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i80, metadata !327, metadata !DIExpression()) #18, !dbg !330
  %5 = sub i64 1, %indvar, !dbg !346
  %6 = sub nuw nsw i64 15, %indvars.iv.i80, !dbg !346
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 %indvars.iv.i80), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !338
...
for.body.i.i.prol:                                ; preds = %for.body.lr.ph.i.i
  ...
  %10 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %8, double %9) #18, !dbg !350
  store double %10, double* %arrayidx2.i.i.prol, align 8, !dbg !350, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i.prol, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !338
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  ...
  %14 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %12, double %13) #18, !dbg !350
  store double %14, double* %arrayidx2.i.i, align 8, !dbg !350, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !338
  ...
  %17 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %15, double %16) #18, !dbg !350
  store double %17, double* %arrayidx2.i.i.1, align 8, !dbg !350, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i.1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !338
...
for.inc24.i:                                      ; preds = %for.body3.i.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next50.i, metadata !326, metadata !DIExpression()) #18, !dbg !330
...
if.end.i:                                         ; preds = %entry
  ...
  call void @llvm.dbg.value(metadata i32 %div.i, metadata !310, metadata !DIExpression()) #18, !dbg !300
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %Ma, metadata !306, metadata !DIExpression()) #18, !dbg !300
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Ma, i32 %div.i), metadata !307, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_LLVM_convert, 32, DW_ATE_signed, DW_OP_LLVM_convert, 64, DW_ATE_signed, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !300
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx9.i, metadata !308, metadata !DIExpression()) #18, !dbg !300
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx13.i, metadata !309, metadata !DIExpression()) #18, !dbg !300
  detach within %syncreg.i, label %det.achd.i, label %det.cont.i, !dbg !358

det.achd.i:                                       ; preds = %if.end.i
  %idxprom4.i = sext i32 %div.i to i64, !dbg !359
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Ma, i64 %idxprom4.i), metadata !307, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !300
  %arrayidx5.i = getelementptr inbounds [16 x [16 x double]], [16 x [16 x double]]* %Ma, i64 %idxprom4.i, !dbg !359
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx5.i, metadata !307, metadata !DIExpression()) #18, !dbg !300
  tail call void @aux_upper_solve([16 x [16 x double]]* noundef %Ma, [16 x [16 x double]]* noundef %arrayidx5.i, [16 x [16 x double]]* noundef %U, i32 noundef %div.i) #18, !dbg !358
  reattach within %syncreg.i, label %det.cont.i, !dbg !358

det.cont.i:                                       ; preds = %det.achd.i, %if.end.i
  tail call void @aux_upper_solve([16 x [16 x double]]* noundef %arrayidx9.i, [16 x [16 x double]]* noundef %arrayidx13.i, [16 x [16 x double]]* noundef %U, i32 noundef %div.i) #18, !dbg !360
...
for.cond1.preheader.i50.preheader:                ; preds = %for.inc24.i
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %Mb, metadata !303, metadata !DIExpression()) #18, !dbg !363
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx12, metadata !304, metadata !DIExpression()) #18, !dbg !363
  call void @llvm.dbg.value(metadata i32 %nb, metadata !305, metadata !DIExpression()) #18, !dbg !363
...
for.cond1.preheader.i50:                          ; preds = %for.cond1.preheader.i50.preheader, %for.inc24.i73
  %indvars.iv49.i49 = phi i64 [ %indvars.iv.next50.i71, %for.inc24.i73 ], [ 0, %for.cond1.preheader.i50.preheader ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv49.i49, metadata !326, metadata !DIExpression()) #18, !dbg !367
  call void @llvm.dbg.value(metadata i64 0, metadata !327, metadata !DIExpression()) #18, !dbg !367
  ...
  call void @llvm.dbg.value(metadata double %div.i5487, metadata !141, metadata !DIExpression()) #18, !dbg !371
  call void @llvm.dbg.value(metadata double* %arrayidx17.i5688, metadata !142, metadata !DIExpression()) #18, !dbg !371
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Mb, i64 %indvars.iv49.i49), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_plus_uconst, 8, DW_OP_stack_value)) #18, !dbg !371
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 0), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !371
  br label %for.body.lr.ph.i.i61, !dbg !373

for.body3.i59.loopexit:                           ; preds = %for.body.i.i68, %for.body.i.i68.prol.loopexit
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i5592, metadata !327, metadata !DIExpression()) #18, !dbg !367
  ...
  call void @llvm.dbg.value(metadata double %div.i54, metadata !141, metadata !DIExpression()) #18, !dbg !371
  call void @llvm.dbg.value(metadata double* %arrayidx17.i56, metadata !142, metadata !DIExpression()) #18, !dbg !371
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Mb, i64 %indvars.iv49.i49, i64 %indvars.iv.next.i55), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_LLVM_arg, 2, DW_OP_constu, 8, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !371
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 %indvars.iv.next.i5592), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !371
...
for.body.lr.ph.i.i61:                             ; preds = %for.cond1.preheader.i50, %for.body3.i59.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i5190, metadata !327, metadata !DIExpression()) #18, !dbg !367
  %22 = sub i64 1, %indvar96, !dbg !379
  %23 = sub nuw nsw i64 15, %indvars.iv.i5190, !dbg !379
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 %indvars.iv.i5190), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !371
...
for.body.i.i68.prol:                              ; preds = %for.body.lr.ph.i.i61
  ...
  %27 = tail call double @llvm.fmuladd.f64(double %neg.i.i60, double %25, double %26) #18, !dbg !383
  store double %27, double* %arrayidx2.i.i66.prol, align 8, !dbg !383, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i63.prol, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !371
...
for.body.i.i68:                                   ; preds = %for.body.i.i68.prol.loopexit, %for.body.i.i68
  ...
  %31 = tail call double @llvm.fmuladd.f64(double %neg.i.i60, double %29, double %30) #18, !dbg !383
  store double %31, double* %arrayidx2.i.i66, align 8, !dbg !383, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i63, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !371
  ...
  %34 = tail call double @llvm.fmuladd.f64(double %neg.i.i60, double %32, double %33) #18, !dbg !383
  store double %34, double* %arrayidx2.i.i66.1, align 8, !dbg !383, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i63.1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !371
...
for.inc24.i73:                                    ; preds = %for.body3.i59.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next50.i71, metadata !326, metadata !DIExpression()) #18, !dbg !367
...
if.end.i40:                                       ; preds = %det.cont.i
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx12, metadata !304, metadata !DIExpression()) #18, !dbg !363
  call void @llvm.dbg.value(metadata i32 %nb, metadata !305, metadata !DIExpression()) #18, !dbg !363
  call void @llvm.dbg.value(metadata i32 %div.i, metadata !310, metadata !DIExpression()) #18, !dbg !363
  %35 = load i32, i32* @nBlocks, align 4, !dbg !388, !tbaa !166
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %Mb, metadata !306, metadata !DIExpression()) #18, !dbg !363
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Mb, i32 %div.i), metadata !307, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_LLVM_convert, 32, DW_ATE_signed, DW_OP_LLVM_convert, 64, DW_ATE_signed, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !363
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx9.i36, metadata !308, metadata !DIExpression()) #18, !dbg !363
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx13.i39, metadata !309, metadata !DIExpression()) #18, !dbg !363
  detach within %syncreg.i, label %det.achd.i43, label %det.cont.i44, !dbg !391

det.achd.i43:                                     ; preds = %if.end.i40
  %idxprom4.i41 = sext i32 %div.i to i64, !dbg !392
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %Mb, i64 %idxprom4.i41), metadata !307, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !363
  %arrayidx5.i42 = getelementptr inbounds [16 x [16 x double]], [16 x [16 x double]]* %Mb, i64 %idxprom4.i41, !dbg !392
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx5.i42, metadata !307, metadata !DIExpression()) #18, !dbg !363
  tail call void @aux_upper_solve([16 x [16 x double]]* noundef %Mb, [16 x [16 x double]]* noundef %arrayidx5.i42, [16 x [16 x double]]* noundef %arrayidx12, i32 noundef %div.i) #18, !dbg !391
  reattach within %syncreg.i, label %det.cont.i44, !dbg !391

det.cont.i44:                                     ; preds = %det.achd.i43, %if.end.i40
  tail call void @aux_upper_solve([16 x [16 x double]]* noundef %arrayidx9.i36, [16 x [16 x double]]* noundef %arrayidx13.i39, [16 x [16 x double]]* noundef %arrayidx12, i32 noundef %div.i) #18, !dbg !393
  sync within %syncreg.i, label %upper_solve.exit45.tfend.tfend, !dbg !394

upper_solve.exit45.tfend.tfend:                   ; preds = %for.inc24.i73, %det.cont.i44
  ret void, !dbg !395
}
...
for.cond1.preheader.i:                            ; preds = %for.cond1.preheader.i.preheader, %for.inc24.i
  %indvars.iv49.i = phi i64 [ %indvars.iv.next50.i, %for.inc24.i ], [ 0, %for.cond1.preheader.i.preheader ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv49.i, metadata !326, metadata !DIExpression()) #18, !dbg !401
  call void @llvm.dbg.value(metadata i32 0, metadata !327, metadata !DIExpression()) #18, !dbg !401
  call void @llvm.dbg.value(metadata i64 0, metadata !327, metadata !DIExpression()) #18, !dbg !401
  ...
  call void @llvm.dbg.value(metadata double %div.i37, metadata !141, metadata !DIExpression()) #18, !dbg !405
  call void @llvm.dbg.value(metadata double* %arrayidx17.i38, metadata !142, metadata !DIExpression()) #18, !dbg !405
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %M, i64 %indvars.iv49.i), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_plus_uconst, 8, DW_OP_stack_value)) #18, !dbg !405
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 0), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !405
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 0), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !405
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 0), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !405
  br label %for.body.lr.ph.i.i, !dbg !407

for.body3.i.loopexit:                             ; preds = %for.body.i.i, %for.body.i.i.prol.loopexit
  %.lcssa = phi double* [ %.lcssa.unr, %for.body.i.i.prol.loopexit ], [ %12, %for.body.i.i ], !dbg !408
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i42, metadata !327, metadata !DIExpression()) #18, !dbg !401
  ...
  call void @llvm.dbg.value(metadata double %div.i, metadata !141, metadata !DIExpression()) #18, !dbg !405
  call void @llvm.dbg.value(metadata double* %arrayidx17.i, metadata !142, metadata !DIExpression()) #18, !dbg !405
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %M, i64 %indvars.iv49.i, i64 %indvars.iv.next.i), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_LLVM_arg, 2, DW_OP_constu, 8, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !405
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 %indvars.iv.next.i42), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !405
...
for.body.lr.ph.i.i:                               ; preds = %for.cond1.preheader.i, %for.body3.i.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i40, metadata !327, metadata !DIExpression()) #18, !dbg !401
  %4 = sub i64 1, %indvar, !dbg !414
  %5 = sub nuw nsw i64 15, %indvars.iv.i40, !dbg !414
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 %indvars.iv.i40), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !405
...
for.body.i.i.prol:                                ; preds = %for.body.lr.ph.i.i
  ...
  %9 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %7, double %8) #18, !dbg !418
  store double %9, double* %arrayidx2.i.i.prol, align 8, !dbg !418, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i.prol, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !405
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i.new
  ...
  %15 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %13, double %14) #18, !dbg !418
  store double %15, double* %arrayidx2.i.i, align 8, !dbg !418, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !405
  ...
  %18 = tail call double @llvm.fmuladd.f64(double %neg.i.i, double %16, double %17) #18, !dbg !418
  store double %18, double* %arrayidx2.i.i.1, align 8, !dbg !418, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i.1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !405
...
for.inc24.i:                                      ; preds = %for.body3.i.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next50.i, metadata !326, metadata !DIExpression()) #18, !dbg !401
...
cleanup:                                          ; preds = %for.inc24.i, %det.cont
  ret void, !dbg !431
}
...
for.cond.loopexit.i:                              ; preds = %elem_daxmy.exit.loopexit.us.i, %for.body.i
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next56.i, metadata !455, metadata !DIExpression()) #18, !dbg !458
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.cond.loopexit.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv55.i, metadata !455, metadata !DIExpression()) #18, !dbg !458
  %0 = sub nsw i64 1, %indvars.iv55.i, !dbg !463
  %indvars.iv.next56.i = add nuw nsw i64 %indvars.iv55.i, 1, !dbg !463
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next56.i, metadata !454, metadata !DIExpression()) #18, !dbg !458
...
for.body3.us.i:                                   ; preds = %elem_daxmy.exit.loopexit.us.i, %for.body3.us.preheader.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv52.i, metadata !454, metadata !DIExpression()) #18, !dbg !458
  ...
  call void @llvm.dbg.value(metadata double %div.us.i, metadata !141, metadata !DIExpression()) #18, !dbg !473
  call void @llvm.dbg.value(metadata double* %arrayidx18.i, metadata !142, metadata !DIExpression()) #18, !dbg !473
  call void @llvm.dbg.value(metadata double* %arrayidx23.us.i, metadata !143, metadata !DIExpression()) #18, !dbg !473
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i32 undef), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !473
...
for.body.i.us.i.prol:                             ; preds = %for.body3.us.i
  ...
  %7 = tail call double @llvm.fmuladd.f64(double %neg.i.us.i, double %5, double %6) #18, !dbg !478
  store double %7, double* %arrayidx2.i.us.i.prol, align 8, !dbg !478, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.us.i.prol, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !473
...
for.body.i.us.i:                                  ; preds = %for.body.i.us.i.prol.loopexit, %for.body.i.us.i
  ...
  %10 = tail call double @llvm.fmuladd.f64(double %neg.i.us.i, double %8, double %9) #18, !dbg !478
  store double %10, double* %arrayidx2.i.us.i, align 8, !dbg !478, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.us.i, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !473
  ...
  %13 = tail call double @llvm.fmuladd.f64(double %neg.i.us.i, double %11, double %12) #18, !dbg !478
  store double %13, double* %arrayidx2.i.us.i.1, align 8, !dbg !478, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.us.i.1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !473
...
elem_daxmy.exit.loopexit.us.i:                    ; preds = %for.body.i.us.i, %for.body.i.us.i.prol.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next53.i, metadata !454, metadata !DIExpression()) #18, !dbg !458
...
if.end:                                           ; preds = %entry, %sync.continue
...
det.achd:                                         ; preds = %if.end
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx4, metadata !203, metadata !DIExpression()) #18, !dbg !493
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %M.tr66, metadata !204, metadata !DIExpression()) #18, !dbg !493
  call void @llvm.dbg.value(metadata i32 %div, metadata !205, metadata !DIExpression()) #18, !dbg !493
...
if.then.i:                                        ; preds = %det.achd
  ...
  tail call fastcc void @block_lower_solve([16 x double]* noundef %arraydecay.i, [16 x double]* noundef %arraydecay1.i) #18, !dbg !499
  br label %lower_solve.exit, !dbg !500

if.end.i:                                         ; preds = %det.achd
  %div.i = sdiv i32 %nb.tr67, 4, !dbg !501
  call void @llvm.dbg.value(metadata i32 %div.i, metadata !210, metadata !DIExpression()) #18, !dbg !493
  %17 = load i32, i32* @nBlocks, align 4, !dbg !502, !tbaa !166
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx4, metadata !206, metadata !DIExpression()) #18, !dbg !493
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx5.i40, metadata !207, metadata !DIExpression()) #18, !dbg !493
  %mul6.i = mul nsw i32 %17, %div.i, !dbg !504
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %arrayidx4, i32 %mul6.i), metadata !208, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_LLVM_convert, 32, DW_ATE_signed, DW_OP_LLVM_convert, 64, DW_ATE_signed, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !493
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx13.i, metadata !209, metadata !DIExpression()) #18, !dbg !493
  detach within %syncreg.i, label %det.achd.i, label %det.cont.i, !dbg !506

det.achd.i:                                       ; preds = %if.end.i
  %idxprom8.i = sext i32 %mul6.i to i64, !dbg !504
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %arrayidx4, i64 %idxprom8.i), metadata !208, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !493
  %arrayidx9.i = getelementptr inbounds [16 x [16 x double]], [16 x [16 x double]]* %arrayidx4, i64 %idxprom8.i, !dbg !504
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx9.i, metadata !208, metadata !DIExpression()) #18, !dbg !493
  tail call void @aux_lower_solve([16 x [16 x double]]* noundef %arrayidx4, [16 x [16 x double]]* noundef %arrayidx9.i, [16 x [16 x double]]* noundef %M.tr66, i32 noundef %div.i) #18, !dbg !506
  reattach within %syncreg.i, label %det.cont.i, !dbg !506

det.cont.i:                                       ; preds = %det.achd.i, %if.end.i
  tail call void @aux_lower_solve([16 x [16 x double]]* noundef %arrayidx5.i40, [16 x [16 x double]]* noundef %arrayidx13.i, [16 x [16 x double]]* noundef %M.tr66, i32 noundef %div.i) #18, !dbg !507
  sync within %syncreg.i, label %lower_solve.exit, !dbg !508

lower_solve.exit:                                 ; preds = %if.then.i, %det.cont.i
  reattach within %syncreg, label %det.cont.tf, !dbg !492

det.cont.tf:                                      ; preds = %if.end, %lower_solve.exit
  %syncreg.i41 = tail call token @llvm.syncregion.start() #18, !dbg !509
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx8, metadata !303, metadata !DIExpression()) #18, !dbg !509
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %M.tr66, metadata !304, metadata !DIExpression()) #18, !dbg !509
  call void @llvm.dbg.value(metadata i32 %div, metadata !305, metadata !DIExpression()) #18, !dbg !509
...
for.cond1.preheader.i.i:                          ; preds = %for.cond1.preheader.i.i.preheader, %for.inc24.i.i
  %indvars.iv49.i.i = phi i64 [ %indvars.iv.next50.i.i, %for.inc24.i.i ], [ 0, %for.cond1.preheader.i.i.preheader ]
  call void @llvm.dbg.value(metadata i64 %indvars.iv49.i.i, metadata !326, metadata !DIExpression()) #18, !dbg !515
  call void @llvm.dbg.value(metadata i64 0, metadata !327, metadata !DIExpression()) #18, !dbg !515
  ...
  call void @llvm.dbg.value(metadata double %div.i.i57, metadata !141, metadata !DIExpression()) #18, !dbg !519
  call void @llvm.dbg.value(metadata double* %arrayidx17.i.i58, metadata !142, metadata !DIExpression()) #18, !dbg !519
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %M.tr66, i64 %idxprom7, i64 %indvars.iv49.i.i), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_LLVM_arg, 2, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_plus_uconst, 8, DW_OP_stack_value)) #18, !dbg !519
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 0), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !519
  br label %for.body.lr.ph.i.i.i, !dbg !521

for.body3.i.i.loopexit:                           ; preds = %for.body.i.i.i, %for.body.i.i.i.prol.loopexit
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i62, metadata !327, metadata !DIExpression()) #18, !dbg !515
  ...
  call void @llvm.dbg.value(metadata double %div.i.i, metadata !141, metadata !DIExpression()) #18, !dbg !519
  call void @llvm.dbg.value(metadata double* %arrayidx17.i.i, metadata !142, metadata !DIExpression()) #18, !dbg !519
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %M.tr66, i64 %idxprom7, i64 %indvars.iv49.i.i, i64 %indvars.iv.next.i.i), metadata !143, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_LLVM_arg, 2, DW_OP_constu, 128, DW_OP_mul, DW_OP_plus, DW_OP_LLVM_arg, 3, DW_OP_constu, 8, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !519
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 %indvars.iv.next.i.i62), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !519
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond1.preheader.i.i, %for.body3.i.i.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i.i60, metadata !327, metadata !DIExpression()) #18, !dbg !515
  %24 = sub i64 1, %indvar, !dbg !527
  %25 = sub nuw nsw i64 15, %indvars.iv.i.i60, !dbg !527
  call void @llvm.dbg.value(metadata !DIArgList(i32 15, i64 %indvars.iv.i.i60), metadata !144, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_minus, DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !519
...
for.body.i.i.i.prol:                              ; preds = %for.body.lr.ph.i.i.i
  ...
  %29 = tail call double @llvm.fmuladd.f64(double %neg.i.i.i, double %27, double %28) #18, !dbg !531
  store double %29, double* %arrayidx2.i.i.i.prol, align 8, !dbg !531, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i.i.prol, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !519
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %33 = tail call double @llvm.fmuladd.f64(double %neg.i.i.i, double %31, double %32) #18, !dbg !531
  store double %33, double* %arrayidx2.i.i.i, align 8, !dbg !531, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i.i, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !519
  ...
  %36 = tail call double @llvm.fmuladd.f64(double %neg.i.i.i, double %34, double %35) #18, !dbg !531
  store double %36, double* %arrayidx2.i.i.i.1, align 8, !dbg !531, !tbaa !75
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i.i.i.1, metadata !144, metadata !DIExpression(DW_OP_constu, 1, DW_OP_minus, DW_OP_stack_value)) #18, !dbg !519
...
for.inc24.i.i:                                    ; preds = %for.body3.i.i.loopexit
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next50.i.i, metadata !326, metadata !DIExpression()) #18, !dbg !515
...
if.end.i50:                                       ; preds = %det.cont.tf
  ...
  call void @llvm.dbg.value(metadata i32 %div.i43, metadata !310, metadata !DIExpression()) #18, !dbg !509
  %37 = load i32, i32* @nBlocks, align 4, !dbg !537, !tbaa !166
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx8, metadata !306, metadata !DIExpression()) #18, !dbg !509
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %arrayidx8, i32 %div.i43), metadata !307, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_LLVM_convert, 32, DW_ATE_signed, DW_OP_LLVM_convert, 64, DW_ATE_signed, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !509
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx9.i46, metadata !308, metadata !DIExpression()) #18, !dbg !509
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx13.i49, metadata !309, metadata !DIExpression()) #18, !dbg !509
...
det.achd.i53:                                     ; preds = %if.end.i50
  ...
  call void @llvm.dbg.value(metadata !DIArgList([16 x [16 x double]]* %arrayidx8, i64 %idxprom4.i51), metadata !307, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 2048, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #18, !dbg !509
  %arrayidx5.i52 = getelementptr inbounds [16 x [16 x double]], [16 x [16 x double]]* %arrayidx8, i64 %idxprom4.i51, !dbg !541
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %arrayidx5.i52, metadata !307, metadata !DIExpression()) #18, !dbg !509
  tail call void @aux_upper_solve([16 x [16 x double]]* noundef %arrayidx8, [16 x [16 x double]]* noundef %arrayidx5.i52, [16 x [16 x double]]* noundef %M.tr66, i32 noundef %div.i43) #18, !dbg !540
  reattach within %syncreg.i41, label %det.cont.i54, !dbg !540

det.cont.i54:                                     ; preds = %det.achd.i53, %if.end.i50
  tail call void @aux_upper_solve([16 x [16 x double]]* noundef %arrayidx9.i46, [16 x [16 x double]]* noundef %arrayidx13.i49, [16 x [16 x double]]* noundef %M.tr66, i32 noundef %div.i43) #18, !dbg !542
  sync within %syncreg.i41, label %upper_solve.exit.tfend, !dbg !543

upper_solve.exit.tfend:                           ; preds = %for.inc24.i.i, %det.cont.i54
...
cleanup.sink.split:                               ; preds = %while.end, %entry
  %puts.i9 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([22 x i8], [22 x i8]* @str, i64 0, i64 0)) #18, !dbg !564
  %puts6.i10 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([9 x i8], [9 x i8]* @str.20, i64 0, i64 0)) #18, !dbg !564
  %puts7.i11 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([70 x i8], [70 x i8]* @str.21, i64 0, i64 0)) #18, !dbg !564
  %puts8.i12 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([50 x i8], [50 x i8]* @str.22, i64 0, i64 0)) #18, !dbg !564
  %puts9.i13 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([24 x i8], [24 x i8]* @str.23, i64 0, i64 0)) #18, !dbg !564
  %call5.i14 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i64 0, i64 0), i32 noundef 256) #18, !dbg !564
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #18, !dbg !603
  %1 = bitcast i32* %test to i8*, !dbg !603
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1) #18, !dbg !603
  %2 = bitcast i32* %n to i8*, !dbg !603
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %2) #18, !dbg !603
  %3 = bitcast i32* %benchmark to i8*, !dbg !603
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #18, !dbg !603
  %4 = bitcast i32* %help to i8*, !dbg !603
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #18, !dbg !603
  %5 = bitcast i32* %round to i8*, !dbg !603
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #18, !dbg !603
  ...
  call void (i32, i8**, i8**, i32*, ...) @get_options(i32 noundef %argc, i8** noundef %argv, i8** noundef getelementptr inbounds ([7 x i8*], [7 x i8*]* @specifiers, i64 0, i64 0), i32* noundef getelementptr inbounds ([7 x i32], [7 x i32]* @opt_types, i64 0, i64 0), i32* noundef nonnull %n, i32* noundef nonnull %print, i32* noundef nonnull %test, i32* noundef nonnull %benchmark, i32* noundef nonnull %help, i32* noundef nonnull %round) #18, !dbg !608
...
if.then:                                          ; preds = %entry
  %puts.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([22 x i8], [22 x i8]* @str, i64 0, i64 0)) #18, !dbg !612
  %puts6.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([9 x i8], [9 x i8]* @str.20, i64 0, i64 0)) #18, !dbg !614
  %puts7.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([70 x i8], [70 x i8]* @str.21, i64 0, i64 0)) #18, !dbg !615
  %puts8.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([50 x i8], [50 x i8]* @str.22, i64 0, i64 0)) #18, !dbg !616
  %puts9.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([24 x i8], [24 x i8]* @str.23, i64 0, i64 0)) #18, !dbg !617
  %call5.i = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i64 0, i64 0), i32 noundef 256) #18, !dbg !618
...
if.end5:                                          ; preds = %if.end, %sw.bb, %sw.bb3, %sw.bb4
  ...
  call void @llvm.dbg.value(metadata i32 %8, metadata !562, metadata !DIExpression()) #18, !dbg !634
  call void @llvm.dbg.value(metadata i32 %8, metadata !563, metadata !DIExpression()) #18, !dbg !634
  %cmp.i = icmp slt i32 %8, 16, !dbg !636
  br i1 %cmp.i, label %invalid_input.exit, label %while.cond.i, !dbg !637

while.cond.i:                                     ; preds = %if.end5, %while.cond.i
  %v.0.i = phi i32 [ %shr.i, %while.cond.i ], [ %8, %if.end5 ], !dbg !634
  call void @llvm.dbg.value(metadata i32 %v.0.i, metadata !563, metadata !DIExpression()) #18, !dbg !634
  %and.i = and i32 %v.0.i, 1, !dbg !638
  %tobool.not.i = icmp eq i32 %and.i, 0, !dbg !639
  %shr.i = ashr i32 %v.0.i, 1, !dbg !640
  call void @llvm.dbg.value(metadata i32 %shr.i, metadata !563, metadata !DIExpression()) #18, !dbg !634
...
invalid_input.exit:                               ; preds = %if.end5, %while.end.i
  %puts.i9.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([22 x i8], [22 x i8]* @str, i64 0, i64 0)) #18, !dbg !634
  %puts6.i10.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([9 x i8], [9 x i8]* @str.20, i64 0, i64 0)) #18, !dbg !634
  %puts7.i11.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([70 x i8], [70 x i8]* @str.21, i64 0, i64 0)) #18, !dbg !634
  %puts8.i12.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([50 x i8], [50 x i8]* @str.22, i64 0, i64 0)) #18, !dbg !634
  %puts9.i13.i = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([24 x i8], [24 x i8]* @str.23, i64 0, i64 0)) #18, !dbg !634
  %call5.i14.i = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i64 0, i64 0), i32 noundef 256) #18, !dbg !634
...
if.end9:                                          ; preds = %while.end.i
  ...
  %call11 = call noalias i8* @malloc(i64 noundef %mul10) #18, !dbg !652
...
if.then13:                                        ; preds = %if.end9
  ...
  %14 = call i64 @fwrite(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.12, i64 0, i64 0), i64 19, i64 1, %struct._IO_FILE* %13) #19, !dbg !665
...
for.body:                                         ; preds = %if.end50.for.body_crit_edge, %for.body.lr.ph
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %9, metadata !668, metadata !DIExpression()) #18, !dbg !678
  call void @llvm.dbg.value(metadata i32 %15, metadata !671, metadata !DIExpression()) #18, !dbg !678
  call void @srand(i32 noundef 1) #18, !dbg !680
  call void @llvm.dbg.value(metadata i32 0, metadata !672, metadata !DIExpression()) #18, !dbg !678
  %cmp73.i = icmp sgt i32 %15, 0, !dbg !681
  br i1 %cmp73.i, label %for.cond1.preheader.us.i, label %init_matrix.exit, !dbg !684

for.cond1.preheader.us.i:                         ; preds = %for.body, %for.cond1.for.inc20_crit_edge.us.i
  %I.074.us.i = phi i32 [ %inc21.us.i, %for.cond1.for.inc20_crit_edge.us.i ], [ 0, %for.body ]
  call void @llvm.dbg.value(metadata i32 %I.074.us.i, metadata !672, metadata !DIExpression()) #18, !dbg !678
  call void @llvm.dbg.value(metadata i32 0, metadata !673, metadata !DIExpression()) #18, !dbg !678
...
for.inc17.us.i:                                   ; preds = %for.cond7.preheader.us.i
  ...
  call void @llvm.dbg.value(metadata i32 %inc18.us.i, metadata !673, metadata !DIExpression()) #18, !dbg !678
...
for.cond7.preheader.us.i:                         ; preds = %for.cond4.preheader.us.i, %for.cond7.preheader.us.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i, metadata !675, metadata !DIExpression()) #18, !dbg !678
  call void @llvm.dbg.value(metadata i64 0, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 1, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.1.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 2, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.2.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 3, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.3.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 4, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.4.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 5, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.5.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 6, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.6.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 7, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.7.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 8, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.8.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 9, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.9.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 10, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.10.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 11, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.11.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 12, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.12.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 13, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.13.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 14, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.14.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 15, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %call.us.15.i = call i32 @rand() #18, !dbg !692
  ...
  call void @llvm.dbg.value(metadata i64 16, metadata !676, metadata !DIExpression()) #18, !dbg !678
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !701
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i, metadata !675, metadata !DIExpression()) #18, !dbg !678
...
for.cond4.preheader.us.i:                         ; preds = %for.inc17.us.i, %for.cond1.preheader.us.i
  ...
  call void @llvm.dbg.value(metadata i32 %J.072.us.i, metadata !673, metadata !DIExpression()) #18, !dbg !678
  call void @llvm.dbg.value(metadata i32 0, metadata !675, metadata !DIExpression()) #18, !dbg !678
...
for.cond1.for.inc20_crit_edge.us.i:               ; preds = %for.inc17.us.i
  ...
  call void @llvm.dbg.value(metadata i32 %inc21.us.i, metadata !672, metadata !DIExpression()) #18, !dbg !678
...
for.cond27.preheader.lr.ph.i:                     ; preds = %for.cond1.for.inc20_crit_edge.us.i
  call void @llvm.dbg.value(metadata i32 0, metadata !674, metadata !DIExpression()) #18, !dbg !678
...
for.cond27.preheader.i:                           ; preds = %for.cond27.preheader.i, %for.cond27.preheader.lr.ph.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv87.i, metadata !674, metadata !DIExpression()) #18, !dbg !678
  %mul31.i = mul nsw i32 %31, %indvars91.i
  %32 = sext i32 %mul31.i to i64
  %33 = add nsw i64 %indvars.iv87.i, %32
  call void @llvm.dbg.value(metadata i64 0, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 1, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 2, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 3, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 4, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 5, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 6, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 7, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 8, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 9, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 10, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 11, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 12, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 13, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 14, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 15, metadata !677, metadata !DIExpression()) #18, !dbg !678
  ...
  call void @llvm.dbg.value(metadata i64 16, metadata !677, metadata !DIExpression()) #18, !dbg !678
  %indvars.iv.next88.i = add nuw nsw i64 %indvars.iv87.i, 1, !dbg !717
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next88.i, metadata !674, metadata !DIExpression()) #18, !dbg !678
...
if.then18:                                        ; preds = %init_matrix.exit
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %9, metadata !724, metadata !DIExpression()) #18, !dbg !730
  call void @llvm.dbg.value(metadata i32 %51, metadata !727, metadata !DIExpression()) #18, !dbg !730
  call void @llvm.dbg.value(metadata i32 0, metadata !728, metadata !DIExpression()) #18, !dbg !730
...
for.cond1.preheader.us.preheader.i:               ; preds = %if.then18
  %mul.i = shl i32 %51, 4
  %smax.i = call i32 @llvm.smax.i32(i32 %mul.i, i32 1) #18, !dbg !735
...
for.cond1.preheader.us.i79:                       ; preds = %for.cond1.for.end_crit_edge.us.i, %for.cond1.preheader.us.preheader.i
  ...
  call void @llvm.dbg.value(metadata i32 %i.028.us.i, metadata !728, metadata !DIExpression()) #18, !dbg !730
  call void @llvm.dbg.value(metadata i32 0, metadata !729, metadata !DIExpression()) #18, !dbg !730
...
for.body4.us.i:                                   ; preds = %for.body4.us.i, %for.cond1.preheader.us.i79
  ...
  call void @llvm.dbg.value(metadata i32 %j.026.us.i, metadata !729, metadata !DIExpression()) #18, !dbg !730
  ...
  %call.us.i82 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i64 0, i64 0), double noundef %53) #18, !dbg !741
  %inc.us.i = add nuw nsw i32 %j.026.us.i, 1, !dbg !742
  call void @llvm.dbg.value(metadata i32 %inc.us.i, metadata !729, metadata !DIExpression()) #18, !dbg !730
...
for.cond1.for.end_crit_edge.us.i:                 ; preds = %for.body4.us.i
  %putchar.us.i = call i32 @putchar(i32 10) #18, !dbg !746
  %inc14.us.i = add nuw nsw i32 %i.028.us.i, 1, !dbg !747
  call void @llvm.dbg.value(metadata i32 %inc14.us.i, metadata !728, metadata !DIExpression()) #18, !dbg !730
...
if.end19:                                         ; preds = %for.cond1.for.end_crit_edge.us.i, %if.then18, %init_matrix.exit
  ...
  %call23 = call noalias i8* @malloc(i64 noundef %mul22) #18, !dbg !753
...
if.end27:                                         ; preds = %if.end19
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %11) #18, !dbg !759
  call void @llvm.dbg.declare(metadata %struct.timeval* %t1, metadata !597, metadata !DIExpression()), !dbg !760
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %12) #18, !dbg !759
  call void @llvm.dbg.declare(metadata %struct.timeval* %t2, metadata !600, metadata !DIExpression()), !dbg !761
  %call31 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #18, !dbg !762
  %56 = load i32, i32* @nBlocks, align 4, !dbg !763, !tbaa !166
  call void @lu([16 x [16 x double]]* noundef nonnull %9, i32 noundef %56), !dbg !764
  %call32 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #18, !dbg !765
...
if.then40:                                        ; preds = %if.end27
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %9, metadata !724, metadata !DIExpression()) #18, !dbg !785
  call void @llvm.dbg.value(metadata i32 %62, metadata !727, metadata !DIExpression()) #18, !dbg !785
  call void @llvm.dbg.value(metadata i32 0, metadata !728, metadata !DIExpression()) #18, !dbg !785
...
for.cond1.preheader.us.preheader.i91:             ; preds = %if.then40
  ...
  %smax.i90 = call i32 @llvm.smax.i32(i32 %mul.i89, i32 1) #18, !dbg !788
...
for.cond1.preheader.us.i96:                       ; preds = %for.cond1.for.end_crit_edge.us.i112, %for.cond1.preheader.us.preheader.i91
  ...
  call void @llvm.dbg.value(metadata i32 %i.028.us.i92, metadata !728, metadata !DIExpression()) #18, !dbg !785
  call void @llvm.dbg.value(metadata i32 0, metadata !729, metadata !DIExpression()) #18, !dbg !785
...
for.body4.us.i108:                                ; preds = %for.body4.us.i108, %for.cond1.preheader.us.i96
  ...
  call void @llvm.dbg.value(metadata i32 %j.026.us.i97, metadata !729, metadata !DIExpression()) #18, !dbg !785
  ...
  %call.us.i105 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i64 0, i64 0), double noundef %64) #18, !dbg !791
  %inc.us.i106 = add nuw nsw i32 %j.026.us.i97, 1, !dbg !792
  call void @llvm.dbg.value(metadata i32 %inc.us.i106, metadata !729, metadata !DIExpression()) #18, !dbg !785
...
for.cond1.for.end_crit_edge.us.i112:              ; preds = %for.body4.us.i108
  %putchar.us.i109 = call i32 @putchar(i32 10) #18, !dbg !796
  %inc14.us.i110 = add nuw nsw i32 %i.028.us.i92, 1, !dbg !797
  call void @llvm.dbg.value(metadata i32 %inc14.us.i110, metadata !728, metadata !DIExpression()) #18, !dbg !785
...
land.rhs:                                         ; preds = %if.end41
  ...
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %9, metadata !804, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* %55, metadata !809, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata i32 %66, metadata !810, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !818, metadata !DIExpression()) #18, !dbg !820
  %puts.i114 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @str.25, i64 0, i64 0)) #18, !dbg !822
  call void @llvm.dbg.value(metadata i32 0, metadata !814, metadata !DIExpression()) #18, !dbg !820
...
for.cond1.preheader.lr.ph.i:                      ; preds = %land.rhs
  ...
  %smax.i116 = call i32 @llvm.smax.i32(i32 %mul.i115, i32 1) #18, !dbg !826
...
for.cond1.preheader.us.i119:                      ; preds = %for.cond1.for.inc58_crit_edge.us.i, %for.cond1.preheader.lr.ph.i
  ...
  call void @llvm.dbg.value(metadata i32 %i.0136.us.i, metadata !814, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata i32 0, metadata !815, metadata !DIExpression()) #18, !dbg !820
...
for.cond1.us139.i:                                ; preds = %for.body4.us141.i
  call void @llvm.dbg.value(metadata i32 undef, metadata !815, metadata !DIExpression()) #18, !dbg !820
...
for.body4.us141.i:                                ; preds = %for.cond1.preheader.us.i119, %for.cond1.us139.i
  %j.0117.us142.i = phi i32 [ %inc56.us156.i, %for.cond1.us139.i ], [ 0, %for.cond1.preheader.us.i119 ]
  call void @llvm.dbg.value(metadata i32 %j.0117.us142.i, metadata !815, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata i32 %div.us.i117, metadata !811, metadata !DIExpression()) #18, !dbg !820
  %div5.us143.i = lshr i32 %j.0117.us142.i, 4, !dbg !836
  call void @llvm.dbg.value(metadata i32 %div5.us143.i, metadata !812, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !819, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata i32 0, metadata !816, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata i32 0, metadata !813, metadata !DIExpression(DW_OP_constu, 4, DW_OP_shr, DW_OP_stack_value)) #18, !dbg !820
  ...
  call void @llvm.dbg.value(metadata double undef, metadata !819, metadata !DIExpression()) #18, !dbg !820
  ...
  %70 = call double @llvm.fabs.f64(double %sub.us154.i) #18, !dbg !843
  call void @llvm.dbg.value(metadata double %70, metadata !817, metadata !DIExpression()) #18, !dbg !820
  %cmp52.us155.i = fcmp ogt double %70, 0x3EB0C6F7A0B5ED8D, !dbg !844
  %inc56.us156.i = add nuw nsw i32 %j.0117.us142.i, 1, !dbg !846
  call void @llvm.dbg.value(metadata i32 %inc56.us156.i, metadata !815, metadata !DIExpression()) #18, !dbg !820
...
for.cond1.for.inc58_crit_edge.us.i:               ; preds = %for.cond1.us.us.i, %for.cond1.us139.i
  ...
  call void @llvm.dbg.value(metadata i32 %inc59.us.i, metadata !814, metadata !DIExpression()) #18, !dbg !820
...
for.body4.us.us.i:                                ; preds = %for.cond1.preheader.us.i119, %for.cond1.us.us.i
  %j.0117.us.us.i = phi i32 [ %inc56.us.us.i, %for.cond1.us.us.i ], [ 0, %for.cond1.preheader.us.i119 ]
  call void @llvm.dbg.value(metadata i32 %j.0117.us.us.i, metadata !815, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata i32 %div.us.i117, metadata !811, metadata !DIExpression()) #18, !dbg !820
  %div5.us.us.i = lshr i32 %j.0117.us.us.i, 4, !dbg !836
  call void @llvm.dbg.value(metadata i32 %div5.us.us.i, metadata !812, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !819, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata i32 0, metadata !816, metadata !DIExpression()) #18, !dbg !820
...
if.then.us.us.i:                                  ; preds = %for.cond6.for.end_crit_edge.us.us.i
  call void @llvm.dbg.value(metadata i32 %div.us.i117, metadata !813, metadata !DIExpression()) #18, !dbg !820
  ...
  call void @llvm.dbg.value(metadata double %add41.us.us.i, metadata !819, metadata !DIExpression()) #18, !dbg !820
...
if.end.us.us.i:                                   ; preds = %for.cond6.for.end_crit_edge.us.us.i, %if.then.us.us.i
  ...
  call void @llvm.dbg.value(metadata double %v.1.us.us.i, metadata !819, metadata !DIExpression()) #18, !dbg !820
  ...
  %73 = call double @llvm.fabs.f64(double %sub.us.us.i) #18, !dbg !843
  call void @llvm.dbg.value(metadata double %73, metadata !817, metadata !DIExpression()) #18, !dbg !820
  %cmp52.us.us.i = fcmp ogt double %73, 0x3EB0C6F7A0B5ED8D, !dbg !844
  %inc56.us.us.i = add nuw nsw i32 %j.0117.us.us.i, 1, !dbg !846
  call void @llvm.dbg.value(metadata i32 %inc56.us.us.i, metadata !815, metadata !DIExpression()) #18, !dbg !820
...
for.body9.us.us.i:                                ; preds = %for.body9.us.us.i, %for.body4.us.us.i
  ...
  call void @llvm.dbg.value(metadata double %v.0113.us.us.i, metadata !819, metadata !DIExpression()) #18, !dbg !820
  call void @llvm.dbg.value(metadata i32 %k.0112.us.us.i, metadata !816, metadata !DIExpression()) #18, !dbg !820
  %div10.us.us.i = lshr i32 %k.0112.us.us.i, 4, !dbg !854
  call void @llvm.dbg.value(metadata i32 %div10.us.us.i, metadata !813, metadata !DIExpression()) #18, !dbg !820
  ...
  %76 = call double @llvm.fmuladd.f64(double %74, double %75, double %v.0113.us.us.i) #18, !dbg !859
  call void @llvm.dbg.value(metadata double %76, metadata !819, metadata !DIExpression()) #18, !dbg !820
  %inc.us.us.i = add nuw nsw i32 %k.0112.us.us.i, 1, !dbg !860
  call void @llvm.dbg.value(metadata i32 %inc.us.us.i, metadata !816, metadata !DIExpression()) #18, !dbg !820
...
if.else:                                          ; preds = %for.cond1.for.inc58_crit_edge.us.i, %land.rhs, %if.end41
  ...
  %79 = call i64 @fwrite(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.15, i64 0, i64 0), i64 18, i64 1, %struct._IO_FILE* %78) #19, !dbg !871
  ...
  %call49 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %80, i8* noundef getelementptr inbounds ([33 x i8], [33 x i8]* @.str.16, i64 0, i64 0), i32 noundef %81) #19, !dbg !874
  br label %if.end50

if.end50:                                         ; preds = %if.else, %if.then46
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %12) #18, !dbg !875
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %11) #18, !dbg !875
...
cleanup:                                          ; preds = %if.end19
  ...
  %84 = call i64 @fwrite(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.12, i64 0, i64 0), i64 19, i64 1, %struct._IO_FILE* %83) #19, !dbg !881
  call void @llvm.dbg.value(metadata [16 x [16 x double]]* undef, metadata !594, metadata !DIExpression()), !dbg !602
  br label %cleanup51

for.end:                                          ; preds = %if.end50, %for.cond.preheader
  %85 = phi i8* [ null, %for.cond.preheader ], [ %call23, %if.end50 ]
  call void @free(i8* noundef %call11) #18, !dbg !882
  call void @free(i8* noundef %85) #18, !dbg !883
  br label %cleanup51, !dbg !884

cleanup51:                                        ; preds = %cleanup, %invalid_input.exit, %for.end, %if.then13, %if.then
  %retval.1 = phi i32 [ 1, %if.then ], [ 0, %for.end ], [ 1, %cleanup ], [ 1, %if.then13 ], [ 1, %invalid_input.exit ], !dbg !602
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #18, !dbg !885
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #18, !dbg !885
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #18, !dbg !885
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #18, !dbg !885
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1) #18, !dbg !885
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #18, !dbg !885
