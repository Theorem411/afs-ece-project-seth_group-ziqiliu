...
pfor.body.entry:                                  ; preds = %pfor.cond
  ...
  %call = tail call double @sin(double noundef %g.0.g.0.g.0.) #15
...
entry:
  ...
  %call = tail call noalias i8* @malloc(i64 noundef %mul) #15
...
sync.continue:                                    ; preds = %do.end
  ...
  tail call void @free(i8* noundef %call) #15
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %call = tail call double @cos(double noundef %mul) #15
  ...
  %call11 = tail call double @sin(double noundef %mul) #15
...
if.then:                                          ; preds = %entry
  ...
  %472 = tail call double @llvm.fmuladd.f64(double %conv878.i, double 0x3FC8F8B83C6993FD, double %neg882.i) #15
  %conv883.i = fptrunc double %472 to float
  %mul887.i = fmul double %conv878.i, 0x3FEF6297CFF75494
  %473 = tail call double @llvm.fmuladd.f64(double %conv880.i, double 0x3FC8F8B83C6993FD, double %mul887.i) #15
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %call = tail call double @cos(double noundef %div) #15
  %conv5 = fptrunc double %call to float
  %call15 = tail call double @sin(double noundef %div) #15
...
for.end:                                          ; preds = %for.body, %entry
  ...
  store float %14, float* %sum.sroa.0.0..sroa_idx, align 4, !tbaa.struct !29
  ...
  store float %15, float* %sum.sroa.6.0..sroa_idx48, align 4, !tbaa.struct !30
  ret void
}
...
for.body.i.us:                                    ; preds = %for.body.i.us, %for.body.lr.ph.i.us
  ...
  %call.i.us = tail call double @cos(double noundef %div.i.us) #15
  %conv5.i.us = fptrunc double %call.i.us to float
  %call15.i.us = tail call double @sin(double noundef %div.i.us) #15
  ...
  br i1 %exitcond.not.i.us, label %test_fft_elem.exit.loopexit.us, label %for.body.i.us, !llvm.loop !28

pfor.inc.us:                                      ; preds = %test_fft_elem.exit.loopexit.us, %pfor.cond.us
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count.i
  br i1 %exitcond.not, label %pfor.cond.cleanup, label %pfor.cond.us, !llvm.loop !31
...
test_fft_elem.exit.loopexit.us:                   ; preds = %for.body.i.us
  ...
  store float %14, float* %sum.sroa.0.0..sroa_idx.i.us, align 4, !tbaa.struct !29
  ...
  store float %15, float* %sum.sroa.6.0..sroa_idx48.i.us, align 4, !tbaa.struct !30
...
entry:
  ...
  %call = tail call noalias dereferenceable_or_null(6400) i8* @malloc(i64 noundef 6400) #15
  %0 = bitcast i8* %call to %struct.COMPLEX*
  %call1 = tail call noalias dereferenceable_or_null(6400) i8* @malloc(i64 noundef 6400) #15
  %1 = bitcast i8* %call1 to %struct.COMPLEX*
  %call2 = tail call noalias dereferenceable_or_null(6400) i8* @malloc(i64 noundef 6400) #15
  %2 = bitcast i8* %call2 to %struct.COMPLEX*
  %call3 = tail call noalias dereferenceable_or_null(6400) i8* @malloc(i64 noundef 6400) #15
...
vector.body:                                      ; preds = %vector.body, %vector.ph.new
  ...
  br i1 %niter.ncmp.1, label %middle.block.unr-lcssa, label %vector.body, !llvm.loop !32
...
for.body6:                                        ; preds = %for.body6, %for.body6.preheader
  ...
  br i1 %exitcond.not, label %for.end, label %for.body6, !llvm.loop !34
...
for.body.i.us.i:                                  ; preds = %for.body.i.us.i, %for.body.lr.ph.i.us.i
  ...
  %call.i.us.i = tail call double @cos(double noundef %div.i.us.i) #15
  %conv5.i.us.i = fptrunc double %call.i.us.i to float
  %call15.i.us.i = tail call double @sin(double noundef %div.i.us.i) #15
  ...
  br i1 %exitcond.not.i.us.i, label %test_fft_elem.exit.loopexit.us.i, label %for.body.i.us.i, !llvm.loop !28
...
pfor.inc.us.i:                                    ; preds = %test_fft_elem.exit.loopexit.us.i, %pfor.cond.us.i
  ...
  br i1 %exitcond.not.i, label %pfor.cond.cleanup.i, label %pfor.cond.us.i, !llvm.loop !36
...
test_fft_elem.exit.loopexit.us.i:                 ; preds = %for.body.i.us.i
  ...
  store float %70, float* %sum.sroa.0.0..sroa_idx.i.us.i, align 4, !tbaa.struct !29
  ...
  store float %71, float* %sum.sroa.6.0..sroa_idx48.i.us.i, align 4, !tbaa.struct !30
...
for.body18:                                       ; preds = %for.body18, %pfor.cond.cleanup.i
  ...
  br i1 %exitcond209.not, label %for.end74, label %for.body18, !llvm.loop !38
...
for.body83:                                       ; preds = %for.body83, %if.then77
  ...
  br i1 %exitcond214.not, label %for.end95, label %for.body83, !llvm.loop !39
...
for.body100:                                      ; preds = %for.body100, %for.end95
  ...
  br i1 %exitcond219.not, label %if.end113, label %for.body100, !llvm.loop !40
...
for.inc119:                                       ; preds = %if.then116, %if.end113
  ...
  br i1 %exitcond223.not, label %for.end121, label %for.cond4.preheader, !llvm.loop !41
...
entry:
  ...
  %call = tail call noalias i8* @malloc(i64 noundef %mul) #15
  %0 = bitcast i8* %call to %struct.COMPLEX*
  %call2 = tail call noalias i8* @malloc(i64 noundef %mul) #15
...
for.body6.us:                                     ; preds = %for.body6.us, %for.body6.us.preheader
  ...
  br i1 %exitcond50.not, label %for.cond3.for.end_crit_edge.us, label %for.body6.us, !llvm.loop !45
...
for.cond3.for.end_crit_edge.us:                   ; preds = %for.body6.us, %middle.block
  ...
  %call9.us = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #15
  tail call void @cilk_fft(i32 noundef %conv10, %struct.COMPLEX* noundef nonnull %0, %struct.COMPLEX* noundef %1)
  %call11.us = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #15
  ...
  %47 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %48 = tail call i64 @fwrite(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.6, i64 0, i64 0), i64 19, i64 1, %struct._IO_FILE* %47) #16
  %49 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %call18.us = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %49, i8* noundef getelementptr inbounds ([41 x i8], [41 x i8]* @.str.7, i64 0, i64 0), i64 noundef %size) #16
  ...
  br i1 %exitcond51.not, label %for.cond.cleanup, label %for.cond3.preheader.us, !llvm.loop !48
...
for.cond3.preheader:                              ; preds = %for.cond3.preheader, %for.cond3.preheader.lr.ph
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %2) #15
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %3) #15
  %call9 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #15
  tail call void @cilk_fft(i32 noundef %conv10, %struct.COMPLEX* noundef %0, %struct.COMPLEX* noundef %1)
  %call11 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #15
  ...
  %54 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %55 = tail call i64 @fwrite(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.6, i64 0, i64 0), i64 19, i64 1, %struct._IO_FILE* %54) #16
  %56 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %call18 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %56, i8* noundef getelementptr inbounds ([41 x i8], [41 x i8]* @.str.7, i64 0, i64 0), i64 noundef %size) #16
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %3) #15
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2) #15
  %inc20 = add nuw nsw i32 %r.047, 1
  %exitcond.not = icmp eq i32 %inc20, %round
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.cond3.preheader, !llvm.loop !48

for.cond.cleanup:                                 ; preds = %for.cond3.preheader, %for.cond3.for.end_crit_edge.us, %entry
  tail call void @free(i8* noundef %call) #15
  tail call void @free(i8* noundef %call2) #15
  ret void
}
...
entry:
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.8, i64 0, i64 0), i64 60, i64 1, %struct._IO_FILE* %0) #16
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %3 = tail call i64 @fwrite(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.9, i64 0, i64 0), i64 60, i64 1, %struct._IO_FILE* %2) #16
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %5 = tail call i64 @fwrite(i8* getelementptr inbounds ([72 x i8], [72 x i8]* @.str.10, i64 0, i64 0), i64 71, i64 1, %struct._IO_FILE* %4) #16
  %6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %7 = tail call i64 @fwrite(i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str.11, i64 0, i64 0), i64 67, i64 1, %struct._IO_FILE* %6) #16
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %9 = tail call i64 @fwrite(i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.12, i64 0, i64 0), i64 56, i64 1, %struct._IO_FILE* %8) #16
  ret i32 1
}
...
entry:
  ...
  store i64 1048576, i64* %size, align 8, !tbaa !49
  store i32 1, i32* %round, align 4, !tbaa !16
  %5 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %call1 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %5, i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.18, i64 0, i64 0), double noundef 0xBFE67CA02266D8B1) #16
  call void (i32, i8**, i8**, i32*, ...) @get_options(i32 noundef %argc, i8** noundef %argv, i8** noundef getelementptr inbounds ([6 x i8*], [6 x i8*]* @specifiers, i64 0, i64 0), i32* noundef getelementptr inbounds ([6 x i32], [6 x i32]* @opt_types, i64 0, i64 0), i64* noundef nonnull %size, i32* noundef nonnull %correctness, i32* noundef nonnull %benchmark, i32* noundef nonnull %help, i32* noundef nonnull %round) #15
  %6 = load i32, i32* %help, align 4, !tbaa !16
  %tobool.not = icmp eq i32 %6, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %7 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %8 = call i64 @fwrite(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.8, i64 0, i64 0), i64 60, i64 1, %struct._IO_FILE* %7) #17
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %10 = call i64 @fwrite(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.9, i64 0, i64 0), i64 60, i64 1, %struct._IO_FILE* %9) #17
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %12 = call i64 @fwrite(i8* getelementptr inbounds ([72 x i8], [72 x i8]* @.str.10, i64 0, i64 0), i64 71, i64 1, %struct._IO_FILE* %11) #17
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %14 = call i64 @fwrite(i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str.11, i64 0, i64 0), i64 67, i64 1, %struct._IO_FILE* %13) #17
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !46
  %16 = call i64 @fwrite(i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.12, i64 0, i64 0), i64 56, i64 1, %struct._IO_FILE* %15) #17
  br label %cleanup
...
sw.bb:                                            ; preds = %if.end
  store i64 16777216, i64* %size, align 8, !tbaa !49
  br label %if.end7

sw.bb5:                                           ; preds = %if.end
  store i64 33554432, i64* %size, align 8, !tbaa !49
  br label %if.end7

sw.bb6:                                           ; preds = %if.end
  store i64 67108864, i64* %size, align 8, !tbaa !49
  br label %if.end7
...
if.else:                                          ; preds = %if.end7
  ...
  %19 = load i64, i64* %size, align 8, !tbaa !49
...
det.cont:                                         ; preds = %det.achd, %if.end
  ...
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !51
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup, label %for.body, !llvm.loop !52
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !53
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !55
...
for.body:                                         ; preds = %for.body, %for.body.prol.loopexit
  ...
  br i1 %exitcond.not.1, label %cleanup, label %for.body, !llvm.loop !56
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !57
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x i64> %strided.vec, <2 x i64>* %17, align 4, !alias.scope !58, !noalias !61
  %18 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %14, i64 2
  %19 = bitcast %struct.COMPLEX* %18 to <2 x i64>*
  store <2 x i64> %strided.vec73, <2 x i64>* %19, align 4, !alias.scope !58, !noalias !61
  %20 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %14, i64 %idxprom
  %21 = bitcast %struct.COMPLEX* %20 to <2 x i64>*
  store <2 x i64> %strided.vec74, <2 x i64>* %21, align 4, !alias.scope !65, !noalias !66
  %22 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %20, i64 2
  %23 = bitcast %struct.COMPLEX* %22 to <2 x i64>*
  store <2 x i64> %strided.vec75, <2 x i64>* %23, align 4, !alias.scope !65, !noalias !66
  %index.next = add nuw i64 %index, 4
  %24 = icmp eq i64 %index.next, %n.vec
  br i1 %24, label %middle.block, label %vector.body, !llvm.loop !67
...
for.body.prol:                                    ; preds = %for.body.prol, %for.body.preheader
  ...
  br i1 %prol.iter.cmp.not, label %for.body.prol.loopexit, label %for.body.prol, !llvm.loop !68
...
for.body:                                         ; preds = %for.body, %for.body.prol.loopexit
  ...
  br i1 %exitcond.not.3, label %cleanup, label %for.body, !llvm.loop !69
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !70
...
for.inc29.us:                                     ; preds = %for.body24.us.prol.loopexit, %for.cond4.for.cond22.preheader_crit_edge.us, %for.body24.us
  ...
  br i1 %exitcond129.not, label %cleanup, label %for.body.us, !llvm.loop !71
...
for.body24.us:                                    ; preds = %for.body24.us.prol.loopexit, %for.body24.us
  ...
  br i1 %exitcond124.not.7, label %for.inc29.us, label %for.body24.us, !llvm.loop !72
...
for.body6.us:                                     ; preds = %for.body6.us, %for.body.us
  ...
  br i1 %niter141.ncmp.1.not, label %for.cond4.for.cond22.preheader_crit_edge.us.unr-lcssa, label %for.body6.us, !llvm.loop !73
...
for.body24.us.prol:                               ; preds = %for.body24.us.prol, %for.body24.us.preheader
  ...
  br i1 %prol.iter.cmp.not, label %for.body24.us.prol.loopexit, label %for.body24.us.prol, !llvm.loop !74
...
for.body24.us109:                                 ; preds = %for.body24.us109, %for.body.us100
  ...
  br i1 %niter.ncmp.7, label %for.cond22.for.inc29_crit_edge.us118.unr-lcssa, label %for.body24.us109, !llvm.loop !72
...
for.body24.us109.epil:                            ; preds = %for.body24.us109.epil, %for.cond22.for.inc29_crit_edge.us118.unr-lcssa
  ...
  br i1 %epil.iter.cmp.not, label %for.cond22.for.inc29_crit_edge.us118, label %for.body24.us109.epil, !llvm.loop !75
...
for.cond22.for.inc29_crit_edge.us118:             ; preds = %for.body24.us109.epil, %for.cond22.for.inc29_crit_edge.us118.unr-lcssa
  ...
  br i1 %exitcond123.not, label %cleanup, label %for.body.us100, !llvm.loop !71
...
det.cont:                                         ; preds = %det.achd, %if.end
  ...
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !76
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  br i1 %exitcond.not, label %cleanup, label %for.body, !llvm.loop !77
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !78
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !80
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !82
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !84
...
for.body3.us.i:                                   ; preds = %for.body3.us.i, %for.body.us.i
  ...
  br i1 %exitcond.not.i, label %for.cond1.for.end_crit_edge.us.i, label %for.body3.us.i, !llvm.loop !87
...
for.cond1.for.end_crit_edge.us.i:                 ; preds = %for.body3.us.i
  ...
  br i1 %exitcond66.not.i, label %return, label %for.body.us.i, !llvm.loop !88
...
det.cont:                                         ; preds = %det.achd, %if.end
  ...
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !89
...
!28 = distinct !{!28, !15}
!29 = !{i64 0, i64 4, !26, i64 4, i64 4, !26}
!30 = !{i64 0, i64 4, !26}
!31 = distinct !{!31, !12, !13}
!32 = distinct !{!32, !15, !33}
!33 = !{!"llvm.loop.isvectorized", i32 1}
!34 = distinct !{!34, !15, !35, !33}
!35 = !{!"llvm.loop.unroll.runtime.disable"}
!36 = distinct !{!36, !12, !37}
!37 = !{!"llvm.loop.prr.dac"}
!38 = distinct !{!38, !15}
!39 = distinct !{!39, !15}
!40 = distinct !{!40, !15}
!41 = distinct !{!41, !15}
!42 = distinct !{!42, !15, !33}
!43 = distinct !{!43, !44}
!44 = !{!"llvm.loop.unroll.disable"}
!45 = distinct !{!45, !15, !35, !33}
!46 = !{!47, !47, i64 0}
...
!65 = !{!62}
!66 = !{!63, !64}
!67 = distinct !{!67, !15, !33}
!68 = distinct !{!68, !44}
!69 = distinct !{!69, !15, !33}
!70 = distinct !{!70, !25}
!71 = distinct !{!71, !15}
!72 = distinct !{!72, !15}
!73 = distinct !{!73, !15}
