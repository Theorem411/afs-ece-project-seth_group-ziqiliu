...
pfor.body.entry:                                  ; preds = %pfor.cond
  ...
  %call = tail call double @sin(double noundef %g.0.g.0.g.0.) #16, !dbg !66
  call void @llvm.dbg.value(metadata double %g.0.g.0.g.0., metadata !46, metadata !DIExpression()), !dbg !55
...
cleanup:                                          ; preds = %for.cond.loopexit, %for.body3, %lor.lhs.false, %entry
...
for.inc.us:                                       ; preds = %for.body3.i.us, %lor.lhs.false.i.us, %det.achd.us, %if.then11.tf.loopexit.us
...
for.inc:                                          ; preds = %for.body, %det.achd
...
for.body19.preheader82:                           ; preds = %for.body19.preheader, %middle.block
...
for.body19:                                       ; preds = %for.body19.preheader82, %for.body19
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #16, !dbg !212
...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i64 0, i64 0), i8* noundef %2) #17, !dbg !221
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !222, !tbaa !218
  %4 = tail call i64 @fwrite(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0), i64 32, i64 1, %struct._IO_FILE* %3) #17, !dbg !223
...
if.else:                                          ; preds = %entry
  ...
  call void @llvm.dbg.value(metadata i8* %5, metadata !228, metadata !DIExpression()) #16, !dbg !236
  call void @llvm.dbg.value(metadata i8* %5, metadata !228, metadata !DIExpression()) #16, !dbg !239
  %call.i = tail call i64 @strtol(i8* nocapture noundef nonnull %5, i8** noundef null, i32 noundef 10) #16, !dbg !227
...
if.then3:                                         ; preds = %if.else
  ...
  %call7 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %6, i8* noundef getelementptr inbounds ([25 x i8], [25 x i8]* @.str.2, i64 0, i64 0), i8* noundef %7, i32 noundef %conv.i) #17, !dbg !245
  br label %if.end15.thread, !dbg !246

if.end15.thread:                                  ; preds = %if.then, %if.then3
...
if.end15:                                         ; preds = %if.else
  ...
  call void @llvm.dbg.value(metadata i8* %8, metadata !228, metadata !DIExpression()) #16, !dbg !251
  %call.i49 = tail call i64 @strtol(i8* nocapture noundef nonnull %8, i8** noundef null, i32 noundef 10) #16, !dbg !253
  ...
  %call14 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %9, i8* noundef getelementptr inbounds ([25 x i8], [25 x i8]* @.str.2, i64 0, i64 0), i8* noundef %10, i32 noundef %conv.i) #17, !dbg !257
  tail call void @startup_cilk(), !dbg !247
  call void @llvm.dbg.value(metadata i32 0, metadata !204, metadata !DIExpression()), !dbg !248
...
for.cond.cleanup:                                 ; preds = %if.end30, %if.end15
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #16, !dbg !259
  ret i32 0, !dbg !260
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end30
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %11) #16, !dbg !264
  call void @llvm.dbg.declare(metadata %struct.timeval* %t1, metadata !206, metadata !DIExpression()), !dbg !265
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %12) #16, !dbg !264
  call void @llvm.dbg.declare(metadata %struct.timeval* %t2, metadata !209, metadata !DIExpression()), !dbg !266
  %call17 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #16, !dbg !267
  ...
  %call18 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #16, !dbg !269
...
if.then26:                                        ; preds = %for.body
  %21 = tail call i64 @fwrite(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.4, i64 0, i64 0), i64 19, i64 1, %struct._IO_FILE* %20) #17, !dbg !290
  br label %if.end30, !dbg !292

if.else28:                                        ; preds = %for.body
  %call29 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %20, i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0), i32 noundef %19) #17, !dbg !293
  br label %if.end30

if.end30:                                         ; preds = %if.else28, %if.then26
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %12) #16, !dbg !295
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %11) #16, !dbg !295
