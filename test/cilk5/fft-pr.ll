...
@.str.2.4 = private unnamed_addr constant [5 x i8] c"long\00", align 1
@.str.3.5 = private unnamed_addr constant [21 x i8] c"\0AInvalid option: %s\0A\00", align 1
...
pfor.body.entry:                                  ; preds = %pfor.cond
  ...
  %call = tail call double @sin(double noundef %g.0.g.0.g.0.) #18
...
entry:
  ...
  %call = tail call noalias i8* @malloc(i64 noundef %mul) #18
...
do.body:                                          ; preds = %factor.exit, %do.body.preheader
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp28.i, label %for.body.i, label %factor.exit, !llvm.loop !14

factor.exit:                                      ; preds = %for.inc.i, %for.body.i, %for.cond.preheader.i, %if.end23.i, %if.end19.i, %if.end15.i, %if.end12.i, %if.end.i, %if.end.i, %if.end.i, %if.end.i, %if.end.i, %if.end.i, %do.body
  ...
  store i32 %retval.0.i, i32* %p.0, align 4, !tbaa !16
...
sync.continue:                                    ; preds = %do.end
  ...
  tail call void @free(i8* noundef %call) #18
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %call = tail call double @cos(double noundef %mul) #18
  ...
  store float %conv4, float* %re, align 4, !tbaa !19
  %re8 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %indvars.iv, i32 0
  store float %conv4, float* %re8, align 4, !tbaa !19
  %call11 = tail call double @sin(double noundef %mul) #18
  ...
  store float %fneg, float* %im, align 4, !tbaa !22
  %im18 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %4, i32 1
  store float %conv12, float* %im18, align 4, !tbaa !22
...
det.cont:                                         ; preds = %det.achd, %if.end
  ...
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !24
...
if.then:                                          ; preds = %entry
  ...
  %1 = load <2 x float>, <2 x float>* %0, align 4, !tbaa !26
  ...
  %3 = load <2 x float>, <2 x float>* %2, align 4, !tbaa !26
  ...
  %8 = load <2 x float>, <2 x float>* %7, align 4, !tbaa !26
  ...
  %10 = load <2 x float>, <2 x float>* %9, align 4, !tbaa !26
  ...
  %194 = load <2 x float>, <2 x float>* %193, align 4, !tbaa !26
  ...
  %196 = load <2 x float>, <2 x float>* %195, align 4, !tbaa !26
  ...
  %201 = load <2 x float>, <2 x float>* %200, align 4, !tbaa !26
  ...
  %203 = load <2 x float>, <2 x float>* %202, align 4, !tbaa !26
  ...
  store float %sub567.i, float* %re569.i, align 4, !tbaa !19
  ...
  store float %sub570.i, float* %im572.i, align 4, !tbaa !22
  ...
  store <4 x float> %395, <4 x float>* %396, align 4, !tbaa !26
  ...
  store float %sub590.i, float* %re592.i, align 4, !tbaa !19
  ...
  store float %sub593.i, float* %im595.i, align 4, !tbaa !22
  ...
  store float %sub737.i, float* %re739.i, align 4, !tbaa !19
  ...
  store float %add740.i, float* %im742.i, align 4, !tbaa !22
  ...
  store <4 x float> %449, <4 x float>* %450, align 4, !tbaa !26
  ...
  store float %sub760.i, float* %re762.i, align 4, !tbaa !19
  ...
  store float %add763.i, float* %im765.i, align 4, !tbaa !22
  ...
  store float %sub783.i, float* %re785.i, align 4, !tbaa !19
  ...
  store float %sub849.i, float* %re851.i, align 4, !tbaa !19
  ...
  %472 = tail call double @llvm.fmuladd.f64(double %conv878.i, double 0x3FC8F8B83C6993FD, double %neg882.i) #18
  %conv883.i = fptrunc double %472 to float
  %mul887.i = fmul double %conv878.i, 0x3FEF6297CFF75494
  %473 = tail call double @llvm.fmuladd.f64(double %conv880.i, double 0x3FC8F8B83C6993FD, double %mul887.i) #18
...
if.then2:                                         ; preds = %entry
  ...
  %477 = load <2 x float>, <2 x float>* %476, align 4, !tbaa !26
  ...
  %482 = load <2 x float>, <2 x float>* %481, align 4, !tbaa !26
  ...
  %484 = load <2 x float>, <2 x float>* %483, align 4, !tbaa !26
  ...
  store <4 x float> %608, <4 x float>* %609, align 4, !tbaa !26
  ...
  store <4 x float> %625, <4 x float>* %626, align 4, !tbaa !26
  ...
  store <4 x float> %632, <4 x float>* %633, align 4, !tbaa !26
  ...
  store <4 x float> %646, <4 x float>* %647, align 4, !tbaa !26
  ...
  store <4 x float> %654, <4 x float>* %655, align 4, !tbaa !26
  ...
  store float %add295.i, float* %im297.i, align 4, !tbaa !22
  ...
  store float %add306.i, float* %re308.i, align 4, !tbaa !19
  ...
  store float %sub309.i, float* %im311.i, align 4, !tbaa !22
  ...
  store float %add329.i368, float* %re331.i, align 4, !tbaa !19
...
if.then5:                                         ; preds = %entry
  ...
  %686 = load <2 x float>, <2 x float>* %685, align 4, !tbaa !26
  ...
  %691 = load <2 x float>, <2 x float>* %690, align 4, !tbaa !26
  ...
  %693 = load <2 x float>, <2 x float>* %692, align 4, !tbaa !26
  ...
  store <4 x float> %726, <4 x float>* %727, align 4, !tbaa !26
  ...
  store <4 x float> %729, <4 x float>* %730, align 4, !tbaa !26
  ...
  store <4 x float> %746, <4 x float>* %747, align 4, !tbaa !26
  ...
  store <4 x float> %751, <4 x float>* %752, align 4, !tbaa !26
  br label %cleanup73

if.then8:                                         ; preds = %entry
  %753 = bitcast %struct.COMPLEX* %in to <2 x float>*
  %754 = load <2 x float>, <2 x float>* %753, align 4, !tbaa !26
  ...
  %756 = load <2 x float>, <2 x float>* %755, align 4, !tbaa !26
  ...
  %761 = load <2 x float>, <2 x float>* %760, align 4, !tbaa !26
  ...
  %763 = load <2 x float>, <2 x float>* %762, align 4, !tbaa !26
...
if.then11:                                        ; preds = %entry
  ...
  %776 = load <2 x float>, <2 x float>* %775, align 4, !tbaa !26
  ...
  store <4 x float> %779, <4 x float>* %780, align 4, !tbaa !26
  br label %cleanup73

if.end12:                                         ; preds = %entry
  %781 = load i32, i32* %factors, align 4, !tbaa !16
  %div = sdiv i32 %n, %781
...
if.end33:                                         ; preds = %if.else28, %if.then27, %if.then24, %if.then21, %if.then18, %if.then16
...
pfor.inc:                                         ; preds = %pfor.body.entry, %pfor.cond
  ...
  br i1 %exitcond.not, label %pfor.cond.cleanup, label %pfor.cond, !llvm.loop !27

pfor.cond.cleanup:                                ; preds = %pfor.inc
  sync within %syncreg, label %if.end46

if.end46:                                         ; preds = %pfor.cond.cleanup, %if.end33, %if.end12
...
cleanup73:                                        ; preds = %if.else66, %if.then64, %if.then60, %if.then56, %if.then52, %if.then48, %if.then11, %if.then8, %if.then5, %if.then2, %if.then
  ret void
}
...
det.cont:                                         ; preds = %det.achd, %if.end
  ...
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !29
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !31
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !33
...
for.body:                                         ; preds = %for.body, %for.body.prol.loopexit
  ...
  br i1 %exitcond.not.1, label %cleanup, label %for.body, !llvm.loop !34
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !35

cleanup:                                          ; preds = %for.body, %for.body.prol.loopexit, %if.then
  sync within %syncreg, label %cleanup.split
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x i64> %strided.vec, <2 x i64>* %17, align 4, !alias.scope !36, !noalias !39
  %18 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %14, i64 2
  %19 = bitcast %struct.COMPLEX* %18 to <2 x i64>*
  store <2 x i64> %strided.vec73, <2 x i64>* %19, align 4, !alias.scope !36, !noalias !39
  %20 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %14, i64 %idxprom
  %21 = bitcast %struct.COMPLEX* %20 to <2 x i64>*
  store <2 x i64> %strided.vec74, <2 x i64>* %21, align 4, !alias.scope !43, !noalias !44
  %22 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %20, i64 2
  %23 = bitcast %struct.COMPLEX* %22 to <2 x i64>*
  store <2 x i64> %strided.vec75, <2 x i64>* %23, align 4, !alias.scope !43, !noalias !44
  %index.next = add nuw i64 %index, 4
  %24 = icmp eq i64 %index.next, %n.vec
  br i1 %24, label %middle.block, label %vector.body, !llvm.loop !45
...
for.body:                                         ; preds = %for.body, %for.body.prol.loopexit
  ...
  br i1 %exitcond.not.3, label %cleanup, label %for.body, !llvm.loop !49
...
cleanup:                                          ; preds = %for.body, %for.body.prol.loopexit, %middle.block, %if.then
  sync within %syncreg, label %cleanup.split
...
for.body.us:                                      ; preds = %for.inc29.us, %for.body.us.preheader
...
for.inc29.us:                                     ; preds = %for.body24.us.prol.loopexit, %for.cond4.for.cond22.preheader_crit_edge.us, %for.body24.us
  ...
  br i1 %exitcond129.not, label %cleanup, label %for.body.us, !llvm.loop !51
...
for.body24.us:                                    ; preds = %for.body24.us.prol.loopexit, %for.body24.us
  ...
  br i1 %exitcond124.not.7, label %for.inc29.us, label %for.body24.us, !llvm.loop !52
...
for.body6.us:                                     ; preds = %for.body6.us, %for.body.us
  ...
  br i1 %niter141.ncmp.1.not, label %for.cond4.for.cond22.preheader_crit_edge.us.unr-lcssa, label %for.body6.us, !llvm.loop !53
...
for.cond4.for.cond22.preheader_crit_edge.us:      ; preds = %for.body6.us.epil, %for.cond4.for.cond22.preheader_crit_edge.us.unr-lcssa
...
for.body24.us.prol:                               ; preds = %for.body24.us.prol, %for.body24.us.preheader
  ...
  br i1 %prol.iter.cmp.not, label %for.body24.us.prol.loopexit, label %for.body24.us.prol, !llvm.loop !54
...
for.body.us100:                                   ; preds = %for.cond22.for.inc29_crit_edge.us118, %for.body.us100.preheader
...
for.body24.us109:                                 ; preds = %for.body24.us109, %for.body.us100
  ...
  br i1 %niter.ncmp.7, label %for.cond22.for.inc29_crit_edge.us118.unr-lcssa, label %for.body24.us109, !llvm.loop !52
...
for.body24.us109.epil:                            ; preds = %for.body24.us109.epil, %for.cond22.for.inc29_crit_edge.us118.unr-lcssa
  ...
  br i1 %epil.iter.cmp.not, label %for.cond22.for.inc29_crit_edge.us118, label %for.body24.us109.epil, !llvm.loop !55
...
for.cond22.for.inc29_crit_edge.us118:             ; preds = %for.body24.us109.epil, %for.cond22.for.inc29_crit_edge.us118.unr-lcssa
  ...
  br i1 %exitcond123.not, label %cleanup, label %for.body.us100, !llvm.loop !51
...
det.cont:                                         ; preds = %det.achd, %if.end
  ...
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !56

cleanup:                                          ; preds = %for.cond22.for.inc29_crit_edge.us118, %for.body.lr.ph.split, %for.inc29.us, %if.then
  sync within %syncreg, label %cleanup.split
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !58
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %11 = load float, float* %re34, align 4, !tbaa !19
  %im38 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %indvars.iv, i32 1
  %12 = load float, float* %im38, align 4, !tbaa !22
  ...
  %13 = load float, float* %re42, align 4, !tbaa !19
  %im46 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx41, i64 0, i32 1
  %14 = load float, float* %im46, align 4, !tbaa !22
  %15 = fneg float %12
  ...
  %19 = load float, float* %re55, align 4, !tbaa !19
  %im59 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %18, i32 1
  %20 = load float, float* %im59, align 4, !tbaa !22
  ...
  %21 = load float, float* %re63, align 4, !tbaa !19
  %im67 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx62, i64 0, i32 1
  %22 = load float, float* %im67, align 4, !tbaa !22
  %23 = fneg float %20
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !60
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %26 = load float, float* %re88, align 4, !tbaa !19
  %im92 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %indvars.iv, i32 1
  %27 = load float, float* %im92, align 4, !tbaa !22
  ...
  %28 = load float, float* %re96, align 4, !tbaa !19
  %im100 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx95, i64 0, i32 1
  %29 = load float, float* %im100, align 4, !tbaa !22
  %30 = fneg float %27
  ...
  %34 = load float, float* %re109, align 4, !tbaa !19
  %im113 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %33, i32 1
  %35 = load float, float* %im113, align 4, !tbaa !22
  ...
  %36 = load float, float* %re117, align 4, !tbaa !19
  %im121 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx116, i64 0, i32 1
  %37 = load float, float* %im121, align 4, !tbaa !22
  %38 = fneg float %35
  ...
  %42 = load float, float* %re134, align 4, !tbaa !19
  %im138 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %41, i32 1
  %43 = load float, float* %im138, align 4, !tbaa !22
  ...
  %44 = load float, float* %re142, align 4, !tbaa !19
  %im146 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx141, i64 0, i32 1
  %45 = load float, float* %im146, align 4, !tbaa !22
  %46 = fneg float %43
  ...
  %50 = load float, float* %re155, align 4, !tbaa !19
  %im159 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %49, i32 1
  %51 = load float, float* %im159, align 4, !tbaa !22
  ...
  %52 = load float, float* %re163, align 4, !tbaa !19
  %im167 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx162, i64 0, i32 1
  %53 = load float, float* %im167, align 4, !tbaa !22
  %54 = fneg float %51
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !62
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %57 = load float, float* %re219, align 4, !tbaa !19
  %im223 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %indvars.iv, i32 1
  %58 = load float, float* %im223, align 4, !tbaa !22
  ...
  %59 = load float, float* %re227, align 4, !tbaa !19
  %im231 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx226, i64 0, i32 1
  %60 = load float, float* %im231, align 4, !tbaa !22
  %61 = fneg float %58
  ...
  %65 = load float, float* %re240, align 4, !tbaa !19
  %im244 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %64, i32 1
  %66 = load float, float* %im244, align 4, !tbaa !22
  ...
  %67 = load float, float* %re248, align 4, !tbaa !19
  %im252 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx247, i64 0, i32 1
  %68 = load float, float* %im252, align 4, !tbaa !22
  %69 = fneg float %66
  ...
  %73 = load float, float* %re265, align 4, !tbaa !19
  %im269 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %72, i32 1
  %74 = load float, float* %im269, align 4, !tbaa !22
  ...
  %75 = load float, float* %re273, align 4, !tbaa !19
  %im277 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx272, i64 0, i32 1
  %76 = load float, float* %im277, align 4, !tbaa !22
  %77 = fneg float %74
  ...
  %81 = load float, float* %re286, align 4, !tbaa !19
  %im290 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %80, i32 1
  %82 = load float, float* %im290, align 4, !tbaa !22
  ...
  %83 = load float, float* %re294, align 4, !tbaa !19
  %im298 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx293, i64 0, i32 1
  %84 = load float, float* %im298, align 4, !tbaa !22
  %85 = fneg float %82
  ...
  %89 = load float, float* %re319, align 4, !tbaa !19
  %im323 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %88, i32 1
  %90 = load float, float* %im323, align 4, !tbaa !22
  ...
  %91 = load float, float* %re327, align 4, !tbaa !19
  %im331 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx326, i64 0, i32 1
  %92 = load float, float* %im331, align 4, !tbaa !22
  %93 = fneg float %90
  ...
  %97 = load float, float* %re340, align 4, !tbaa !19
  %im344 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %96, i32 1
  %98 = load float, float* %im344, align 4, !tbaa !22
  ...
  %99 = load float, float* %re348, align 4, !tbaa !19
  %im352 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx347, i64 0, i32 1
  %100 = load float, float* %im352, align 4, !tbaa !22
  %101 = fneg float %98
  ...
  %105 = load float, float* %re365, align 4, !tbaa !19
  %im369 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %104, i32 1
  %106 = load float, float* %im369, align 4, !tbaa !22
  ...
  %107 = load float, float* %re373, align 4, !tbaa !19
  %im377 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx372, i64 0, i32 1
  %108 = load float, float* %im377, align 4, !tbaa !22
  %109 = fneg float %106
  ...
  %113 = load float, float* %re386, align 4, !tbaa !19
  %im390 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %112, i32 1
  %114 = load float, float* %im390, align 4, !tbaa !22
  ...
  %115 = load float, float* %re394, align 4, !tbaa !19
  %im398 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx393, i64 0, i32 1
  %116 = load float, float* %im398, align 4, !tbaa !22
  %117 = fneg float %114
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !64
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %128 = load float, float* %re543, align 4, !tbaa !19
  %im547 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %indvars.iv, i32 1
  %129 = load float, float* %im547, align 4, !tbaa !22
  ...
  %130 = load float, float* %re551, align 4, !tbaa !19
  %im555 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx550, i64 0, i32 1
  %131 = load float, float* %im555, align 4, !tbaa !22
  %132 = fneg float %129
  ...
  %136 = load float, float* %re564, align 4, !tbaa !19
  %im568 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %135, i32 1
  %137 = load float, float* %im568, align 4, !tbaa !22
  ...
  %138 = load float, float* %re572, align 4, !tbaa !19
  %im576 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx571, i64 0, i32 1
  %139 = load float, float* %im576, align 4, !tbaa !22
  %140 = fneg float %137
  ...
  %144 = load float, float* %re589, align 4, !tbaa !19
  %im593 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %143, i32 1
  %145 = load float, float* %im593, align 4, !tbaa !22
  ...
  %146 = load float, float* %re597, align 4, !tbaa !19
  %im601 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx596, i64 0, i32 1
  %147 = load float, float* %im601, align 4, !tbaa !22
  %148 = fneg float %145
  ...
  %152 = load float, float* %re610, align 4, !tbaa !19
  %im614 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %151, i32 1
  %153 = load float, float* %im614, align 4, !tbaa !22
  ...
  %154 = load float, float* %re618, align 4, !tbaa !19
  %im622 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx617, i64 0, i32 1
  %155 = load float, float* %im622, align 4, !tbaa !22
  %156 = fneg float %153
  ...
  %160 = load float, float* %re643, align 4, !tbaa !19
  %im647 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %159, i32 1
  %161 = load float, float* %im647, align 4, !tbaa !22
  ...
  %162 = load float, float* %re651, align 4, !tbaa !19
  %im655 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx650, i64 0, i32 1
  %163 = load float, float* %im655, align 4, !tbaa !22
  %164 = fneg float %161
  ...
  %168 = load float, float* %re664, align 4, !tbaa !19
  %im668 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %167, i32 1
  %169 = load float, float* %im668, align 4, !tbaa !22
  ...
  %170 = load float, float* %re672, align 4, !tbaa !19
  %im676 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx671, i64 0, i32 1
  %171 = load float, float* %im676, align 4, !tbaa !22
  %172 = fneg float %169
  ...
  %176 = load float, float* %re689, align 4, !tbaa !19
  %im693 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %175, i32 1
  %177 = load float, float* %im693, align 4, !tbaa !22
  ...
  %178 = load float, float* %re697, align 4, !tbaa !19
  %im701 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx696, i64 0, i32 1
  %179 = load float, float* %im701, align 4, !tbaa !22
  %180 = fneg float %177
  ...
  %184 = load float, float* %re710, align 4, !tbaa !19
  %im714 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %183, i32 1
  %185 = load float, float* %im714, align 4, !tbaa !22
  ...
  %186 = load float, float* %re718, align 4, !tbaa !19
  %im722 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx717, i64 0, i32 1
  %187 = load float, float* %im722, align 4, !tbaa !22
  %188 = fneg float %185
  ...
  %192 = load float, float* %re775, align 4, !tbaa !19
  %im779 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %191, i32 1
  %193 = load float, float* %im779, align 4, !tbaa !22
  ...
  %194 = load float, float* %re783, align 4, !tbaa !19
  %im787 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx782, i64 0, i32 1
  %195 = load float, float* %im787, align 4, !tbaa !22
  %196 = fneg float %193
  ...
  %200 = load float, float* %re796, align 4, !tbaa !19
  %im800 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %199, i32 1
  %201 = load float, float* %im800, align 4, !tbaa !22
  ...
  %202 = load float, float* %re804, align 4, !tbaa !19
  %im808 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx803, i64 0, i32 1
  %203 = load float, float* %im808, align 4, !tbaa !22
  %204 = fneg float %201
  ...
  %208 = load float, float* %re821, align 4, !tbaa !19
  %im825 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %207, i32 1
  %209 = load float, float* %im825, align 4, !tbaa !22
  ...
  %210 = load float, float* %re829, align 4, !tbaa !19
  %im833 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx828, i64 0, i32 1
  %211 = load float, float* %im833, align 4, !tbaa !22
  %212 = fneg float %209
  ...
  %216 = load float, float* %re842, align 4, !tbaa !19
  %im846 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %215, i32 1
  %217 = load float, float* %im846, align 4, !tbaa !22
  ...
  %218 = load float, float* %re850, align 4, !tbaa !19
  %im854 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx849, i64 0, i32 1
  %219 = load float, float* %im854, align 4, !tbaa !22
  %220 = fneg float %217
  ...
  %224 = load float, float* %re875, align 4, !tbaa !19
  %im879 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %223, i32 1
  %225 = load float, float* %im879, align 4, !tbaa !22
  ...
  %226 = load float, float* %re883, align 4, !tbaa !19
  %im887 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx882, i64 0, i32 1
  %227 = load float, float* %im887, align 4, !tbaa !22
  %228 = fneg float %225
  ...
  %232 = load float, float* %re896, align 4, !tbaa !19
  %im900 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %231, i32 1
  %233 = load float, float* %im900, align 4, !tbaa !22
  ...
  %234 = load float, float* %re904, align 4, !tbaa !19
  %im908 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx903, i64 0, i32 1
  %235 = load float, float* %im908, align 4, !tbaa !22
  %236 = fneg float %233
  ...
  %240 = load float, float* %re921, align 4, !tbaa !19
  %im925 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %239, i32 1
  %241 = load float, float* %im925, align 4, !tbaa !22
  ...
  %242 = load float, float* %re929, align 4, !tbaa !19
  %im933 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx928, i64 0, i32 1
  %243 = load float, float* %im933, align 4, !tbaa !22
  %244 = fneg float %241
  ...
  %248 = load float, float* %re942, align 4, !tbaa !19
  %im946 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %W, i64 %247, i32 1
  %249 = load float, float* %im946, align 4, !tbaa !22
  ...
  %250 = load float, float* %re950, align 4, !tbaa !19
  %im954 = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %arrayidx949, i64 0, i32 1
  %251 = load float, float* %im954, align 4, !tbaa !22
  %252 = fneg float %249
...
det.cont:                                         ; preds = %det.achd, %if.end
  %sub = sub nsw i32 %b, %div
  %cmp = icmp slt i32 %sub, 128
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !66
...
for.body3.us.i:                                   ; preds = %for.body3.us.i, %for.body.us.i
  ...
  br i1 %exitcond.not.i, label %for.cond1.for.end_crit_edge.us.i, label %for.body3.us.i, !llvm.loop !67
...
for.cond1.for.end_crit_edge.us.i:                 ; preds = %for.body3.us.i
  ...
  store float %13, float* %re16.us.i, align 4, !tbaa !19
  ...
  store float %14, float* %im17.us.i, align 4, !tbaa !22
  ...
  br i1 %exitcond66.not.i, label %return, label %for.body.us.i, !llvm.loop !68
...
det.cont:                                         ; preds = %det.achd, %if.end
  ...
  br i1 %cmp, label %if.then, label %if.end, !llvm.loop !69
...
define dso_local void @test_fft_elem(i32 noundef %n, i32 noundef %j, %struct.COMPLEX* nocapture noundef readonly %in, %struct.COMPLEX* nocapture noundef writeonly %out) local_unnamed_addr #11 {
entry:
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %call = tail call double @cos(double noundef %div) #18
  %conv5 = fptrunc double %call to float
  %call15 = tail call double @sin(double noundef %div) #18
  ...
  %5 = load <2 x float>, <2 x float>* %4, align 4, !tbaa !26
...
for.end:                                          ; preds = %for.body, %entry
  ...
  store float %14, float* %sum.sroa.0.0..sroa_idx, align 4, !tbaa.struct !71
  ...
  store float %15, float* %sum.sroa.6.0..sroa_idx48, align 4, !tbaa.struct !72
  ret void
}
...
for.body.i.us:                                    ; preds = %for.body.i.us, %for.body.lr.ph.i.us
  ...
  %call.i.us = tail call double @cos(double noundef %div.i.us) #18
  %conv5.i.us = fptrunc double %call.i.us to float
  %call15.i.us = tail call double @sin(double noundef %div.i.us) #18
  ...
  %6 = load <2 x float>, <2 x float>* %5, align 4, !tbaa !26
  ...
  br i1 %exitcond.not.i.us, label %test_fft_elem.exit.loopexit.us, label %for.body.i.us, !llvm.loop !70

pfor.inc.us:                                      ; preds = %test_fft_elem.exit.loopexit.us, %pfor.cond.us
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count.i
  br i1 %exitcond.not, label %pfor.cond.cleanup, label %pfor.cond.us, !llvm.loop !73
...
test_fft_elem.exit.loopexit.us:                   ; preds = %for.body.i.us
  ...
  store float %14, float* %sum.sroa.0.0..sroa_idx.i.us, align 4, !tbaa.struct !71
  ...
  store float %15, float* %sum.sroa.6.0..sroa_idx48.i.us, align 4, !tbaa.struct !72
...
entry:
  ...
  %call = tail call noalias dereferenceable_or_null(6400) i8* @malloc(i64 noundef 6400) #18
  %0 = bitcast i8* %call to %struct.COMPLEX*
  %call1 = tail call noalias dereferenceable_or_null(6400) i8* @malloc(i64 noundef 6400) #18
  %1 = bitcast i8* %call1 to %struct.COMPLEX*
  %call2 = tail call noalias dereferenceable_or_null(6400) i8* @malloc(i64 noundef 6400) #18
  %2 = bitcast i8* %call2 to %struct.COMPLEX*
  %call3 = tail call noalias dereferenceable_or_null(6400) i8* @malloc(i64 noundef 6400) #18
  %3 = bitcast i8* %call3 to %struct.COMPLEX*
  br label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.inc119, %entry
...
vector.body:                                      ; preds = %vector.body, %vector.ph.new
  ...
  store <4 x float> %interleaved.vec, <4 x float>* %15, align 4, !tbaa !26
  %interleaved.vec229 = shufflevector <2 x float> %11, <2 x float> zeroinitializer, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x float> %interleaved.vec229, <4 x float>* %17, align 4, !tbaa !26
  ...
  store <4 x float> %interleaved.vec, <4 x float>* %21, align 4, !tbaa !26
  store <4 x float> %interleaved.vec229, <4 x float>* %23, align 4, !tbaa !26
  ...
  store <4 x float> %interleaved.vec.1, <4 x float>* %30, align 4, !tbaa !26
  %interleaved.vec229.1 = shufflevector <2 x float> %26, <2 x float> zeroinitializer, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x float> %interleaved.vec229.1, <4 x float>* %32, align 4, !tbaa !26
  ...
  store <4 x float> %interleaved.vec.1, <4 x float>* %36, align 4, !tbaa !26
  store <4 x float> %interleaved.vec229.1, <4 x float>* %38, align 4, !tbaa !26
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  store <4 x float> %interleaved.vec.epil, <4 x float>* %45, align 4, !tbaa !26
  %interleaved.vec229.epil = shufflevector <2 x float> %41, <2 x float> zeroinitializer, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x float> %interleaved.vec229.epil, <4 x float>* %47, align 4, !tbaa !26
  ...
  store <4 x float> %interleaved.vec.epil, <4 x float>* %51, align 4, !tbaa !26
  store <4 x float> %interleaved.vec229.epil, <4 x float>* %53, align 4, !tbaa !26
...
for.body6.preheader:                              ; preds = %middle.block, %for.cond4.preheader
...
for.body.i.us.i:                                  ; preds = %for.body.i.us.i, %for.body.lr.ph.i.us.i
  ...
  %call.i.us.i = tail call double @cos(double noundef %div.i.us.i) #18
  %conv5.i.us.i = fptrunc double %call.i.us.i to float
  %call15.i.us.i = tail call double @sin(double noundef %div.i.us.i) #18
  ...
  %62 = load <2 x float>, <2 x float>* %61, align 4, !tbaa !26
  ...
  br i1 %exitcond.not.i.us.i, label %test_fft_elem.exit.loopexit.us.i, label %for.body.i.us.i, !llvm.loop !70
...
pfor.inc.us.i:                                    ; preds = %test_fft_elem.exit.loopexit.us.i, %pfor.cond.us.i
  ...
  br i1 %exitcond.not.i, label %pfor.cond.cleanup.i, label %pfor.cond.us.i, !llvm.loop !77
...
test_fft_elem.exit.loopexit.us.i:                 ; preds = %for.body.i.us.i
  ...
  store float %70, float* %sum.sroa.0.0..sroa_idx.i.us.i, align 4, !tbaa.struct !71
  ...
  store float %71, float* %sum.sroa.6.0..sroa_idx48.i.us.i, align 4, !tbaa.struct !72
...
for.body18:                                       ; preds = %for.body18, %pfor.cond.cleanup.i
  ...
  br i1 %exitcond209.not, label %for.end74, label %for.body18, !llvm.loop !79
...
for.body83:                                       ; preds = %for.body83, %if.then77
  ...
  br i1 %exitcond214.not, label %for.end95, label %for.body83, !llvm.loop !80
...
for.body100:                                      ; preds = %for.body100, %for.end95
  ...
  br i1 %exitcond219.not, label %if.end113, label %for.body100, !llvm.loop !81
...
for.inc119:                                       ; preds = %if.then116, %if.end113
  %indvars.iv.next221 = add nuw nsw i64 %indvars.iv220, 1
  %exitcond223.not = icmp eq i64 %indvars.iv.next221, 800
  br i1 %exitcond223.not, label %for.end121, label %for.cond4.preheader, !llvm.loop !82
...
entry:
  ...
  %call = tail call noalias i8* @malloc(i64 noundef %mul) #18
  %0 = bitcast i8* %call to %struct.COMPLEX*
  %call2 = tail call noalias i8* @malloc(i64 noundef %mul) #18
...
for.cond3.preheader.us:                           ; preds = %for.cond3.for.end_crit_edge.us, %for.cond3.preheader.us.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %12, align 4, !tbaa !26
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %14, align 4, !tbaa !26
  %index.next = or i64 %index, 4
  %15 = or i64 %index, 6
  ...
  %21 = bitcast float* %20 to <4 x float>*
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %19, align 4, !tbaa !26
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %21, align 4, !tbaa !26
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %26, align 4, !tbaa !26
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %28, align 4, !tbaa !26
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %33, align 4, !tbaa !26
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %35, align 4, !tbaa !26
  %index.next.3 = add nuw i64 %index, 16
  %niter.next.3 = add nuw i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %middle.block.unr-lcssa, label %vector.body, !llvm.loop !83
...
vector.body.epil:                                 ; preds = %vector.body.epil, %middle.block.unr-lcssa
  ...
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %40, align 4, !tbaa !26
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 1.000000e+00>, <4 x float>* %42, align 4, !tbaa !26
  %index.next.epil = add nuw i64 %index.epil, 4
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %middle.block, label %vector.body.epil, !llvm.loop !84

middle.block:                                     ; preds = %vector.body.epil, %middle.block.unr-lcssa
  br i1 %cmp.n, label %for.cond3.for.end_crit_edge.us, label %for.body6.us.preheader

for.body6.us.preheader:                           ; preds = %middle.block, %for.cond3.preheader.us
...
for.body6.us:                                     ; preds = %for.body6.us, %for.body6.us.preheader
  ...
  store float 1.000000e+00, float* %re.us, align 4, !tbaa !19
  %im.us = getelementptr inbounds %struct.COMPLEX, %struct.COMPLEX* %0, i64 %indvars.iv, i32 1
  store float 1.000000e+00, float* %im.us, align 4, !tbaa !22
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond50.not = icmp eq i64 %indvars.iv.next, %size
  br i1 %exitcond50.not, label %for.cond3.for.end_crit_edge.us, label %for.body6.us, !llvm.loop !85
...
for.cond3.for.end_crit_edge.us:                   ; preds = %for.body6.us, %middle.block
  ...
  %call9.us = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #18
  tail call void @cilk_fft(i32 noundef %conv10, %struct.COMPLEX* noundef nonnull %0, %struct.COMPLEX* noundef %1)
  %call11.us = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #18
  ...
  %47 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %48 = tail call i64 @fwrite(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.6, i64 0, i64 0), i64 19, i64 1, %struct._IO_FILE* %47) #19
  %49 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %call18.us = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %49, i8* noundef getelementptr inbounds ([41 x i8], [41 x i8]* @.str.7, i64 0, i64 0), i64 noundef %size) #19
  ...
  br i1 %exitcond51.not, label %for.cond.cleanup, label %for.cond3.preheader.us, !llvm.loop !88

for.cond3.preheader:                              ; preds = %for.cond3.preheader, %for.cond3.preheader.lr.ph
  %r.047 = phi i32 [ %inc20, %for.cond3.preheader ], [ 0, %for.cond3.preheader.lr.ph ]
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %2) #18
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %3) #18
  %call9 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #18
  tail call void @cilk_fft(i32 noundef %conv10, %struct.COMPLEX* noundef %0, %struct.COMPLEX* noundef %1)
  %call11 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #18
  ...
  %54 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %55 = tail call i64 @fwrite(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.6, i64 0, i64 0), i64 19, i64 1, %struct._IO_FILE* %54) #19
  %56 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %call18 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %56, i8* noundef getelementptr inbounds ([41 x i8], [41 x i8]* @.str.7, i64 0, i64 0), i64 noundef %size) #19
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %3) #18
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2) #18
  %inc20 = add nuw nsw i32 %r.047, 1
  %exitcond.not = icmp eq i32 %inc20, %round
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.cond3.preheader, !llvm.loop !88

for.cond.cleanup:                                 ; preds = %for.cond3.preheader, %for.cond3.for.end_crit_edge.us, %entry
  tail call void @free(i8* noundef %call) #18
  tail call void @free(i8* noundef %call2) #18
  ret void
}
...
; Function Attrs: nofree nounwind uwtable
define dso_local i32 @usage() local_unnamed_addr #11 {
entry:
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.8, i64 0, i64 0), i64 60, i64 1, %struct._IO_FILE* %0) #19
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %3 = tail call i64 @fwrite(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.9, i64 0, i64 0), i64 60, i64 1, %struct._IO_FILE* %2) #19
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %5 = tail call i64 @fwrite(i8* getelementptr inbounds ([72 x i8], [72 x i8]* @.str.10, i64 0, i64 0), i64 71, i64 1, %struct._IO_FILE* %4) #19
  %6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %7 = tail call i64 @fwrite(i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str.11, i64 0, i64 0), i64 67, i64 1, %struct._IO_FILE* %6) #19
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %9 = tail call i64 @fwrite(i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.12, i64 0, i64 0), i64 56, i64 1, %struct._IO_FILE* %8) #19
  ret i32 1
}
...
entry:
  ...
  store i32 0, i32* %correctness, align 4, !tbaa !16
  store i64 1048576, i64* %size, align 8, !tbaa !89
  store i32 1, i32* %round, align 4, !tbaa !16
  %5 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %call1 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %5, i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.18, i64 0, i64 0), double noundef 0xBFE67CA02266D8B1) #19
  call void (i32, i8**, i8**, i32*, ...) @get_options(i32 noundef %argc, i8** noundef %argv, i8** noundef getelementptr inbounds ([6 x i8*], [6 x i8*]* @specifiers, i64 0, i64 0), i32* noundef getelementptr inbounds ([6 x i32], [6 x i32]* @opt_types, i64 0, i64 0), i64* noundef nonnull %size, i32* noundef nonnull %correctness, i32* noundef nonnull %benchmark, i32* noundef nonnull %help, i32* noundef nonnull %round) #18
  %6 = load i32, i32* %help, align 4, !tbaa !16
  %tobool.not = icmp eq i32 %6, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %7 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %8 = call i64 @fwrite(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.8, i64 0, i64 0), i64 60, i64 1, %struct._IO_FILE* %7) #20
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %10 = call i64 @fwrite(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.9, i64 0, i64 0), i64 60, i64 1, %struct._IO_FILE* %9) #20
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %12 = call i64 @fwrite(i8* getelementptr inbounds ([72 x i8], [72 x i8]* @.str.10, i64 0, i64 0), i64 71, i64 1, %struct._IO_FILE* %11) #20
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %14 = call i64 @fwrite(i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str.11, i64 0, i64 0), i64 67, i64 1, %struct._IO_FILE* %13) #20
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !86
  %16 = call i64 @fwrite(i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.12, i64 0, i64 0), i64 56, i64 1, %struct._IO_FILE* %15) #20
  br label %cleanup

if.end:                                           ; preds = %entry
  %17 = load i32, i32* %benchmark, align 4, !tbaa !16
...
sw.bb:                                            ; preds = %if.end
  store i64 16777216, i64* %size, align 8, !tbaa !89
  br label %if.end7

sw.bb5:                                           ; preds = %if.end
  store i64 33554432, i64* %size, align 8, !tbaa !89
  br label %if.end7

sw.bb6:                                           ; preds = %if.end
  store i64 67108864, i64* %size, align 8, !tbaa !89
  br label %if.end7

if.end7:                                          ; preds = %sw.bb6, %sw.bb5, %sw.bb, %if.end
  %18 = load i32, i32* %correctness, align 4, !tbaa !16
...
if.else:                                          ; preds = %if.end7
  ...
  %19 = load i64, i64* %size, align 8, !tbaa !89
  %20 = load i32, i32* %round, align 4, !tbaa !16
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @get_options(i32 noundef %argc, i8** nocapture noundef readonly %argv, i8** noundef readonly %specs, i32* nocapture noundef readonly %types, ...) local_unnamed_addr #11 {
entry:
  %ap = alloca [1 x %struct.__va_list_tag], align 16
  %0 = bitcast [1 x %struct.__va_list_tag]* %ap to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0) #18
  call void @llvm.va_start(i8* nonnull %0)
  %1 = load i32, i32* %types, align 4, !tbaa !16
  %cmp2234 = icmp ne i32 %1, 0
  %cmp22235 = icmp ne i8** %specs, null
  %2 = and i1 %cmp2234, %cmp22235
  br i1 %2, label %while.body.lr.ph, label %while.end

while.body.lr.ph:                                 ; preds = %entry
  %gp_offset_p1197 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 0
  %overflow_arg_area_p1203 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 2
  %3 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %ap, i64 0, i64 0, i32 3
  %cmp12092221 = icmp sgt i32 %argc, 1
  %sub959 = add i32 %argc, -1
  %cmp9602223 = icmp sgt i32 %argc, 2
  %4 = sext i32 %argc to i64
  %wide.trip.count = zext i32 %argc to i64
  %wide.trip.count2251 = zext i32 %sub959 to i64
  br label %while.body

while.body:                                       ; preds = %sw.epilog, %while.body.lr.ph
  %5 = phi i32 [ %1, %while.body.lr.ph ], [ %61, %sw.epilog ]
  %types.pn = phi i32* [ %types, %while.body.lr.ph ], [ %incdec.ptr2237, %sw.epilog ]
  %specs.addr.02236 = phi i8** [ %specs, %while.body.lr.ph ], [ %incdec.ptr2036, %sw.epilog ]
  %incdec.ptr2237 = getelementptr inbounds i32, i32* %types.pn, i64 1
  switch i32 %5, label %sw.epilog [
    i32 1, label %sw.bb
    i32 2, label %sw.bb204
    i32 3, label %sw.bb454
    i32 4, label %sw.bb704
    i32 5, label %sw.bb945
    i32 6, label %sw.bb1195
  ]

sw.bb:                                            ; preds = %while.body
  %gp_offset = load i32, i32* %gp_offset_p1197, align 16
...
vaarg.in_reg:                                     ; preds = %sw.bb
  ...
  %7 = getelementptr i8, i8* %reg_save_area, i64 %6
  %8 = add nuw nsw i32 %gp_offset, 8
  store i32 %8, i32* %gp_offset_p1197, align 16
  br label %vaarg.end

vaarg.in_mem:                                     ; preds = %sw.bb
  %overflow_arg_area = load i8*, i8** %overflow_arg_area_p1203, align 8
  %overflow_arg_area.next = getelementptr i8, i8* %overflow_arg_area, i64 8
  store i8* %overflow_arg_area.next, i8** %overflow_arg_area_p1203, align 8
  br label %vaarg.end

vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  %vaarg.addr.in = phi i8* [ %7, %vaarg.in_reg ], [ %overflow_arg_area, %vaarg.in_mem ]
  %vaarg.addr = bitcast i8* %vaarg.addr.in to i32**
  %9 = load i32*, i32** %vaarg.addr, align 8
  br i1 %cmp9602223, label %for.body, label %sw.epilog

for.body:                                         ; preds = %for.inc, %vaarg.end
  %indvars.iv2270 = phi i64 [ %12, %for.inc ], [ 1, %vaarg.end ]
  %arrayidx183 = getelementptr inbounds i8*, i8** %argv, i64 %indvars.iv2270
  %10 = load i8*, i8** %arrayidx183, align 8, !tbaa !86
  %11 = load i8*, i8** %specs.addr.02236, align 8, !tbaa !86
  %call185 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %10, i8* noundef nonnull dereferenceable(1) %11) #18
  %tobool.not = icmp eq i32 %call185, 0
  %12 = add nuw nsw i64 %indvars.iv2270, 1
  br i1 %tobool.not, label %if.then192, label %for.inc

if.then192:                                       ; preds = %for.body
  %arrayidx194 = getelementptr inbounds i8*, i8** %argv, i64 %12
  %13 = load i8*, i8** %arrayidx194, align 8, !tbaa !86
  %call.i = call i64 @strtol(i8* nocapture noundef nonnull %13, i8** noundef null, i32 noundef 10) #18
  %conv.i = trunc i64 %call.i to i32
  store i32 %conv.i, i32* %9, align 4, !tbaa !16
  %14 = load i8*, i8** %arrayidx183, align 8, !tbaa !86
  store i8 0, i8* %14, align 1, !tbaa !90
  %15 = load i8*, i8** %arrayidx194, align 8, !tbaa !86
  store i8 0, i8* %15, align 1, !tbaa !90
  br label %for.inc

for.inc:                                          ; preds = %if.then192, %for.body
  %exitcond2275.not = icmp eq i64 %12, %wide.trip.count2251
  br i1 %exitcond2275.not, label %sw.epilog, label %for.body, !llvm.loop !91

sw.bb204:                                         ; preds = %while.body
  %gp_offset207 = load i32, i32* %gp_offset_p1197, align 16
  %fits_in_gp208 = icmp ult i32 %gp_offset207, 41
  br i1 %fits_in_gp208, label %vaarg.in_reg209, label %vaarg.in_mem211

vaarg.in_reg209:                                  ; preds = %sw.bb204
  %reg_save_area210 = load i8*, i8** %3, align 16
  %16 = zext i32 %gp_offset207 to i64
  %17 = getelementptr i8, i8* %reg_save_area210, i64 %16
  %18 = add nuw nsw i32 %gp_offset207, 8
  store i32 %18, i32* %gp_offset_p1197, align 16
  br label %vaarg.end215

vaarg.in_mem211:                                  ; preds = %sw.bb204
  %overflow_arg_area213 = load i8*, i8** %overflow_arg_area_p1203, align 8
  %overflow_arg_area.next214 = getelementptr i8, i8* %overflow_arg_area213, i64 8
  store i8* %overflow_arg_area.next214, i8** %overflow_arg_area_p1203, align 8
  br label %vaarg.end215

vaarg.end215:                                     ; preds = %vaarg.in_mem211, %vaarg.in_reg209
  %vaarg.addr216.in = phi i8* [ %17, %vaarg.in_reg209 ], [ %overflow_arg_area213, %vaarg.in_mem211 ]
  %vaarg.addr216 = bitcast i8* %vaarg.addr216.in to double**
  %19 = load double*, double** %vaarg.addr216, align 8
  br i1 %cmp9602223, label %for.body221, label %sw.epilog

for.body221:                                      ; preds = %for.inc451, %vaarg.end215
  %indvars.iv2264 = phi i64 [ %22, %for.inc451 ], [ 1, %vaarg.end215 ]
  %arrayidx428 = getelementptr inbounds i8*, i8** %argv, i64 %indvars.iv2264
  %20 = load i8*, i8** %arrayidx428, align 8, !tbaa !86
  %21 = load i8*, i8** %specs.addr.02236, align 8, !tbaa !86
  %call430 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %20, i8* noundef nonnull dereferenceable(1) %21) #18
  %tobool437.not = icmp eq i32 %call430, 0
  %22 = add nuw nsw i64 %indvars.iv2264, 1
  br i1 %tobool437.not, label %if.then438, label %for.inc451

if.then438:                                       ; preds = %for.body221
  %arrayidx441 = getelementptr inbounds i8*, i8** %argv, i64 %22
  %23 = load i8*, i8** %arrayidx441, align 8, !tbaa !86
  %call.i2214 = call double @strtod(i8* nocapture noundef nonnull %23, i8** noundef null) #18
  store double %call.i2214, double* %19, align 8, !tbaa !9
  %24 = load i8*, i8** %arrayidx428, align 8, !tbaa !86
  store i8 0, i8* %24, align 1, !tbaa !90
  %25 = load i8*, i8** %arrayidx441, align 8, !tbaa !86
  store i8 0, i8* %25, align 1, !tbaa !90
  br label %for.inc451

for.inc451:                                       ; preds = %if.then438, %for.body221
  %exitcond2269.not = icmp eq i64 %22, %wide.trip.count2251
  br i1 %exitcond2269.not, label %sw.epilog, label %for.body221, !llvm.loop !92

sw.bb454:                                         ; preds = %while.body
  %gp_offset457 = load i32, i32* %gp_offset_p1197, align 16
  %fits_in_gp458 = icmp ult i32 %gp_offset457, 41
  br i1 %fits_in_gp458, label %vaarg.in_reg459, label %vaarg.in_mem461

vaarg.in_reg459:                                  ; preds = %sw.bb454
  %reg_save_area460 = load i8*, i8** %3, align 16
  %26 = zext i32 %gp_offset457 to i64
  %27 = getelementptr i8, i8* %reg_save_area460, i64 %26
  %28 = add nuw nsw i32 %gp_offset457, 8
  store i32 %28, i32* %gp_offset_p1197, align 16
  br label %vaarg.end465

vaarg.in_mem461:                                  ; preds = %sw.bb454
  %overflow_arg_area463 = load i8*, i8** %overflow_arg_area_p1203, align 8
  %overflow_arg_area.next464 = getelementptr i8, i8* %overflow_arg_area463, i64 8
  store i8* %overflow_arg_area.next464, i8** %overflow_arg_area_p1203, align 8
  br label %vaarg.end465

vaarg.end465:                                     ; preds = %vaarg.in_mem461, %vaarg.in_reg459
  %vaarg.addr466.in = phi i8* [ %27, %vaarg.in_reg459 ], [ %overflow_arg_area463, %vaarg.in_mem461 ]
  %vaarg.addr466 = bitcast i8* %vaarg.addr466.in to i64**
  %29 = load i64*, i64** %vaarg.addr466, align 8
  br i1 %cmp9602223, label %for.body471, label %sw.epilog

for.body471:                                      ; preds = %for.inc701, %vaarg.end465
  %indvars.iv2258 = phi i64 [ %32, %for.inc701 ], [ 1, %vaarg.end465 ]
  %arrayidx678 = getelementptr inbounds i8*, i8** %argv, i64 %indvars.iv2258
  %30 = load i8*, i8** %arrayidx678, align 8, !tbaa !86
  %31 = load i8*, i8** %specs.addr.02236, align 8, !tbaa !86
  %call680 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %30, i8* noundef nonnull dereferenceable(1) %31) #18
  %tobool687.not = icmp eq i32 %call680, 0
  %32 = add nuw nsw i64 %indvars.iv2258, 1
  br i1 %tobool687.not, label %if.then688, label %for.inc701

if.then688:                                       ; preds = %for.body471
  %arrayidx691 = getelementptr inbounds i8*, i8** %argv, i64 %32
  %33 = load i8*, i8** %arrayidx691, align 8, !tbaa !86
  %call.i2215 = call i64 @strtol(i8* nocapture noundef nonnull %33, i8** noundef null, i32 noundef 10) #18
  store i64 %call.i2215, i64* %29, align 8, !tbaa !89
  %34 = load i8*, i8** %arrayidx678, align 8, !tbaa !86
  store i8 0, i8* %34, align 1, !tbaa !90
  %35 = load i8*, i8** %arrayidx691, align 8, !tbaa !86
  store i8 0, i8* %35, align 1, !tbaa !90
  br label %for.inc701

for.inc701:                                       ; preds = %if.then688, %for.body471
  %exitcond2263.not = icmp eq i64 %32, %wide.trip.count2251
  br i1 %exitcond2263.not, label %sw.epilog, label %for.body471, !llvm.loop !93

sw.bb704:                                         ; preds = %while.body
  %gp_offset707 = load i32, i32* %gp_offset_p1197, align 16
  %fits_in_gp708 = icmp ult i32 %gp_offset707, 41
  br i1 %fits_in_gp708, label %vaarg.in_reg709, label %vaarg.in_mem711

vaarg.in_reg709:                                  ; preds = %sw.bb704
  %reg_save_area710 = load i8*, i8** %3, align 16
  %36 = zext i32 %gp_offset707 to i64
  %37 = getelementptr i8, i8* %reg_save_area710, i64 %36
  %38 = add nuw nsw i32 %gp_offset707, 8
  store i32 %38, i32* %gp_offset_p1197, align 16
  br label %vaarg.end715

vaarg.in_mem711:                                  ; preds = %sw.bb704
  %overflow_arg_area713 = load i8*, i8** %overflow_arg_area_p1203, align 8
  %overflow_arg_area.next714 = getelementptr i8, i8* %overflow_arg_area713, i64 8
  store i8* %overflow_arg_area.next714, i8** %overflow_arg_area_p1203, align 8
  br label %vaarg.end715

vaarg.end715:                                     ; preds = %vaarg.in_mem711, %vaarg.in_reg709
  %vaarg.addr716.in = phi i8* [ %37, %vaarg.in_reg709 ], [ %overflow_arg_area713, %vaarg.in_mem711 ]
  %vaarg.addr716 = bitcast i8* %vaarg.addr716.in to i32**
  %39 = load i32*, i32** %vaarg.addr716, align 8
  store i32 0, i32* %39, align 4, !tbaa !16
  br i1 %cmp12092221, label %for.body720, label %sw.epilog

for.body720:                                      ; preds = %for.inc942, %vaarg.end715
  %indvars.iv2253 = phi i64 [ %indvars.iv.next2254, %for.inc942 ], [ 1, %vaarg.end715 ]
  %arrayidx927 = getelementptr inbounds i8*, i8** %argv, i64 %indvars.iv2253
  %40 = load i8*, i8** %arrayidx927, align 8, !tbaa !86
  %41 = load i8*, i8** %specs.addr.02236, align 8, !tbaa !86
  %call929 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %40, i8* noundef nonnull dereferenceable(1) %41) #18
  %tobool936.not = icmp eq i32 %call929, 0
  br i1 %tobool936.not, label %if.then937, label %for.inc942

if.then937:                                       ; preds = %for.body720
  store i32 1, i32* %39, align 4, !tbaa !16
  store i8 0, i8* %40, align 1, !tbaa !90
  br label %for.inc942

for.inc942:                                       ; preds = %if.then937, %for.body720
  %indvars.iv.next2254 = add nuw nsw i64 %indvars.iv2253, 1
  %exitcond2257.not = icmp eq i64 %indvars.iv.next2254, %wide.trip.count
  br i1 %exitcond2257.not, label %sw.epilog, label %for.body720, !llvm.loop !94

sw.bb945:                                         ; preds = %while.body
  %gp_offset948 = load i32, i32* %gp_offset_p1197, align 16
  %fits_in_gp949 = icmp ult i32 %gp_offset948, 41
  br i1 %fits_in_gp949, label %vaarg.in_reg950, label %vaarg.in_mem952

vaarg.in_reg950:                                  ; preds = %sw.bb945
  %reg_save_area951 = load i8*, i8** %3, align 16
  %42 = zext i32 %gp_offset948 to i64
  %43 = getelementptr i8, i8* %reg_save_area951, i64 %42
  %44 = add nuw nsw i32 %gp_offset948, 8
  store i32 %44, i32* %gp_offset_p1197, align 16
  br label %vaarg.end956

vaarg.in_mem952:                                  ; preds = %sw.bb945
  %overflow_arg_area954 = load i8*, i8** %overflow_arg_area_p1203, align 8
  %overflow_arg_area.next955 = getelementptr i8, i8* %overflow_arg_area954, i64 8
  store i8* %overflow_arg_area.next955, i8** %overflow_arg_area_p1203, align 8
  br label %vaarg.end956

vaarg.end956:                                     ; preds = %vaarg.in_mem952, %vaarg.in_reg950
  %vaarg.addr957.in = phi i8* [ %43, %vaarg.in_reg950 ], [ %overflow_arg_area954, %vaarg.in_mem952 ]
  %vaarg.addr957 = bitcast i8* %vaarg.addr957.in to i8**
  %45 = load i8*, i8** %vaarg.addr957, align 8
  br i1 %cmp9602223, label %for.body962, label %sw.epilog

for.body962:                                      ; preds = %for.inc1192, %vaarg.end956
  %indvars.iv2247 = phi i64 [ %48, %for.inc1192 ], [ 1, %vaarg.end956 ]
  %arrayidx1169 = getelementptr inbounds i8*, i8** %argv, i64 %indvars.iv2247
  %46 = load i8*, i8** %arrayidx1169, align 8, !tbaa !86
  %47 = load i8*, i8** %specs.addr.02236, align 8, !tbaa !86
  %call1171 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %46, i8* noundef nonnull dereferenceable(1) %47) #18
  %tobool1178.not = icmp eq i32 %call1171, 0
  %48 = add nuw nsw i64 %indvars.iv2247, 1
  br i1 %tobool1178.not, label %if.then1179, label %for.inc1192

if.then1179:                                      ; preds = %for.body962
  %arrayidx1182 = getelementptr inbounds i8*, i8** %argv, i64 %48
  %49 = load i8*, i8** %arrayidx1182, align 8, !tbaa !86
  %call1183 = call i8* @strcpy(i8* noundef nonnull dereferenceable(1) %45, i8* noundef nonnull dereferenceable(1) %49) #18
  %50 = load i8*, i8** %arrayidx1169, align 8, !tbaa !86
  store i8 0, i8* %50, align 1, !tbaa !90
  %51 = load i8*, i8** %arrayidx1182, align 8, !tbaa !86
  store i8 0, i8* %51, align 1, !tbaa !90
  br label %for.inc1192

for.inc1192:                                      ; preds = %if.then1179, %for.body962
  %exitcond2252.not = icmp eq i64 %48, %wide.trip.count2251
  br i1 %exitcond2252.not, label %sw.epilog, label %for.body962, !llvm.loop !95

sw.bb1195:                                        ; preds = %while.body
  %gp_offset1198 = load i32, i32* %gp_offset_p1197, align 16
  %fits_in_gp1199 = icmp ult i32 %gp_offset1198, 41
  br i1 %fits_in_gp1199, label %vaarg.in_reg1200, label %vaarg.in_mem1202

vaarg.in_reg1200:                                 ; preds = %sw.bb1195
  %reg_save_area1201 = load i8*, i8** %3, align 16
  %52 = zext i32 %gp_offset1198 to i64
  %53 = getelementptr i8, i8* %reg_save_area1201, i64 %52
  %54 = add nuw nsw i32 %gp_offset1198, 8
  store i32 %54, i32* %gp_offset_p1197, align 16
  br label %vaarg.end1206

vaarg.in_mem1202:                                 ; preds = %sw.bb1195
  %overflow_arg_area1204 = load i8*, i8** %overflow_arg_area_p1203, align 8
  %overflow_arg_area.next1205 = getelementptr i8, i8* %overflow_arg_area1204, i64 8
  store i8* %overflow_arg_area.next1205, i8** %overflow_arg_area_p1203, align 8
  br label %vaarg.end1206

vaarg.end1206:                                    ; preds = %vaarg.in_mem1202, %vaarg.in_reg1200
  %vaarg.addr1207.in = phi i8* [ %53, %vaarg.in_reg1200 ], [ %overflow_arg_area1204, %vaarg.in_mem1202 ]
  %vaarg.addr1207 = bitcast i8* %vaarg.addr1207.in to i32**
  %55 = load i32*, i32** %vaarg.addr1207, align 8
  store i32 0, i32* %55, align 4, !tbaa !16
  br i1 %cmp12092221, label %for.body1211, label %sw.epilog

for.body1211:                                     ; preds = %for.inc2033, %vaarg.end1206
  %indvars.iv = phi i64 [ %indvars.iv.next.pre-phi, %for.inc2033 ], [ 1, %vaarg.end1206 ]
  %arrayidx1418 = getelementptr inbounds i8*, i8** %argv, i64 %indvars.iv
  %56 = load i8*, i8** %arrayidx1418, align 8, !tbaa !86
  %57 = load i8*, i8** %specs.addr.02236, align 8, !tbaa !86
  %call1420 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %56, i8* noundef nonnull dereferenceable(1) %57) #18
  %tobool1427.not = icmp eq i32 %call1420, 0
  br i1 %tobool1427.not, label %if.then1428, label %for.body1211.for.inc2033_crit_edge

for.body1211.for.inc2033_crit_edge:               ; preds = %for.body1211
  %.pre2285 = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc2033

if.then1428:                                      ; preds = %for.body1211
  store i32 2, i32* %55, align 4, !tbaa !16
  %58 = add nuw nsw i64 %indvars.iv, 1
  %cmp1430 = icmp slt i64 %58, %4
  br i1 %cmp1430, label %cond.end1625, label %if.end2028

cond.end1625:                                     ; preds = %if.then1428
  %arrayidx1619 = getelementptr inbounds i8*, i8** %argv, i64 %58
  %59 = load i8*, i8** %arrayidx1619, align 8, !tbaa !86
  %call1620 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %59, i8* noundef nonnull dereferenceable(6) getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0)) #18
  %tobool1627.not = icmp eq i32 %call1620, 0
  br i1 %tobool1627.not, label %if.then1628, label %cond.end1822

if.then1628:                                      ; preds = %cond.end1625
  store i32 1, i32* %55, align 4, !tbaa !16
  br label %cond.end1822

cond.end1822:                                     ; preds = %if.then1628, %cond.end1625
  %call1817 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %59, i8* noundef nonnull dereferenceable(7) getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0)) #18
  %tobool1824.not = icmp eq i32 %call1817, 0
  br i1 %tobool1824.not, label %if.then1825, label %cond.end2019

if.then1825:                                      ; preds = %cond.end1822
  store i32 2, i32* %55, align 4, !tbaa !16
  br label %cond.end2019

cond.end2019:                                     ; preds = %if.then1825, %cond.end1822
  %call2014 = call i32 @strcmp(i8* noundef nonnull dereferenceable(1) %59, i8* noundef nonnull dereferenceable(5) getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2.4, i64 0, i64 0)) #18
  %tobool2021.not = icmp eq i32 %call2014, 0
  br i1 %tobool2021.not, label %if.then2022, label %if.end2023

if.then2022:                                      ; preds = %cond.end2019
  store i32 3, i32* %55, align 4, !tbaa !16
  br label %if.end2023

if.end2023:                                       ; preds = %if.then2022, %cond.end2019
  store i8 0, i8* %59, align 1, !tbaa !90
  %.pre = load i8*, i8** %arrayidx1418, align 8, !tbaa !86
  br label %if.end2028

if.end2028:                                       ; preds = %if.end2023, %if.then1428
  %60 = phi i8* [ %.pre, %if.end2023 ], [ %56, %if.then1428 ]
  store i8 0, i8* %60, align 1, !tbaa !90
  br label %for.inc2033

for.inc2033:                                      ; preds = %if.end2028, %for.body1211.for.inc2033_crit_edge
  %indvars.iv.next.pre-phi = phi i64 [ %.pre2285, %for.body1211.for.inc2033_crit_edge ], [ %58, %if.end2028 ]
  %exitcond.not = icmp eq i64 %indvars.iv.next.pre-phi, %wide.trip.count
  br i1 %exitcond.not, label %sw.epilog, label %for.body1211, !llvm.loop !96

sw.epilog:                                        ; preds = %for.inc2033, %vaarg.end1206, %for.inc1192, %vaarg.end956, %for.inc942, %vaarg.end715, %for.inc701, %vaarg.end465, %for.inc451, %vaarg.end215, %for.inc, %vaarg.end, %while.body
  %incdec.ptr2036 = getelementptr inbounds i8*, i8** %specs.addr.02236, i64 1
  %61 = load i32, i32* %incdec.ptr2237, align 4, !tbaa !16
  %cmp.not = icmp eq i32 %61, 0
  br i1 %cmp.not, label %while.end, label %while.body, !llvm.loop !97

while.end:                                        ; preds = %sw.epilog, %entry
  call void @llvm.va_end(i8* nonnull %0)
  %cmp20402238 = icmp sgt i32 %argc, 1
  br i1 %cmp20402238, label %for.body2042.preheader, label %for.end2056

for.body2042.preheader:                           ; preds = %while.end
  %wide.trip.count2279 = zext i32 %argc to i64
  br label %for.body2042

for.body2042:                                     ; preds = %for.inc2054, %for.body2042.preheader
  %indvars.iv2276 = phi i64 [ 1, %for.body2042.preheader ], [ %indvars.iv.next2277, %for.inc2054 ]
  %arrayidx2044 = getelementptr inbounds i8*, i8** %argv, i64 %indvars.iv2276
  %62 = load i8*, i8** %arrayidx2044, align 8, !tbaa !86
  %63 = load i8, i8* %62, align 1, !tbaa !90
  %cmp2047.not = icmp eq i8 %63, 0
  br i1 %cmp2047.not, label %for.inc2054, label %if.then2049

if.then2049:                                      ; preds = %for.body2042
  %call2052 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3.5, i64 0, i64 0), i8* noundef nonnull %62)
  br label %for.inc2054

for.inc2054:                                      ; preds = %if.then2049, %for.body2042
  %indvars.iv.next2277 = add nuw nsw i64 %indvars.iv2276, 1
  %exitcond2280.not = icmp eq i64 %indvars.iv.next2277, %wide.trip.count2279
  br i1 %exitcond2280.not, label %for.end2056, label %for.body2042, !llvm.loop !98

for.end2056:                                      ; preds = %for.inc2054, %while.end
...
declare dso_local i32 @strcmp(i8* nocapture noundef, i8* nocapture noundef) local_unnamed_addr #15

; Function Attrs: mustprogress nofree nounwind willreturn
declare dso_local i64 @strtol(i8* noundef readonly, i8** nocapture noundef, i32 noundef) local_unnamed_addr #16

; Function Attrs: mustprogress nofree nounwind willreturn
declare dso_local double @strtod(i8* noundef readonly, i8** nocapture noundef) local_unnamed_addr #16

; Function Attrs: argmemonly mustprogress nofree nounwind willreturn
declare dso_local i8* @strcpy(i8* noalias noundef returned writeonly, i8* noalias nocapture noundef readonly) local_unnamed_addr #17
...
attributes #17 = { argmemonly mustprogress nofree nounwind willreturn "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!0 = !{!"clang version 14.0.6 (/afs/ece/project/seth_group/ziqiliu/uli-opencilk-project/clang a9be1306ca6ed5a9814f041c1db11a9ffe20487b)"}
...
!69 = distinct !{!69, !25}
!70 = distinct !{!70, !15}
!71 = !{i64 0, i64 4, !26, i64 4, i64 4, !26}
!72 = !{i64 0, i64 4, !26}
!73 = distinct !{!73, !12, !13}
!74 = distinct !{!74, !15, !46}
!75 = distinct !{!75, !15, !76, !46}
!76 = !{!"llvm.loop.unroll.runtime.disable"}
!77 = distinct !{!77, !12, !78}
!78 = !{!"llvm.loop.prr.dac"}
!79 = distinct !{!79, !15}
!80 = distinct !{!80, !15}
!81 = distinct !{!81, !15}
!82 = distinct !{!82, !15}
!83 = distinct !{!83, !15, !46}
!84 = distinct !{!84, !48}
!85 = distinct !{!85, !15, !76, !46}
!86 = !{!87, !87, i64 0}
!87 = !{!"any pointer", !6, i64 0}
!88 = distinct !{!88, !15}
!89 = !{!5, !5, i64 0}
!90 = !{!6, !6, i64 0}
!91 = distinct !{!91, !15}
