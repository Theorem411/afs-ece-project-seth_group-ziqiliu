...
pfor.body.entry:                                  ; preds = %pfor.cond
  ...
  %call = tail call double @sin(double noundef %g.0.g.0.g.0.) #15, !dbg !108
  call void @llvm.dbg.value(metadata double %g.0.g.0.g.0., metadata !89, metadata !DIExpression()), !dbg !97
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %call = tail call noalias i8* @malloc(i64 noundef %mul) #15, !dbg !138
  %1 = bitcast double** %rol.018 to i8**, !dbg !140
  store i8* %call, i8** %1, align 8, !dbg !140, !tbaa !141
  %call5 = tail call noalias i8* @malloc(i64 noundef %mul) #15, !dbg !143
...
for.body12.lr.ph:                                 ; preds = %for.body, %for.body.prol.loopexit
...
for.body12.prol:                                  ; preds = %for.body12.lr.ph
  ...
  %call13.prol = tail call double @sin(double noundef %18) #15, !dbg !184
...
for.body12:                                       ; preds = %for.body12, %for.body12.prol.loopexit
  ...
  %call13 = tail call double @sin(double noundef %24) #15, !dbg !184
  ...
  %call13.1 = tail call double @sin(double noundef %29) #15, !dbg !184
...
for.end20:                                        ; preds = %for.body12, %for.body12.prol.loopexit, %entry
...
for.body41:                                       ; preds = %for.body41, %for.body41.lr.ph
  ...
  %call45 = tail call double @sin(double noundef %41) #15, !dbg !208
...
for.cond59.preheader:                             ; preds = %for.inc78, %for.cond59.preheader.preheader
...
for.body63:                                       ; preds = %for.body63, %for.body63.lr.ph
  ...
  %call66 = tail call double @sin(double noundef %50) #15, !dbg !227
  ...
  %call69 = tail call double @sin(double noundef %54) #15, !dbg !227
...
for.cond7.preheader.us:                           ; preds = %for.cond7.for.inc49_crit_edge.us, %for.cond7.preheader.us.preheader
...
for.body10.us.preheader:                          ; preds = %middle.block, %vector.memcheck, %for.cond7.preheader.us
...
for.body69.prol:                                  ; preds = %for.body69.prol, %for.body69.preheader
...
for.body55:                                       ; preds = %for.body55, %for.body55.lr.ph
  ...
  %call = tail call double @exp(double noundef %mul) #15, !dbg !320
  ...
  %call57 = tail call double @sin(double noundef %54) #15, !dbg !320
...
for.body69:                                       ; preds = %for.body69, %for.body69.prol.loopexit
...
for.end76:                                        ; preds = %for.body69, %for.body69.prol.loopexit, %entry
...
for.body97:                                       ; preds = %for.body97, %for.body97.lr.ph
  ...
  %call99 = tail call double @exp(double noundef %mul98) #15, !dbg !345
  ...
  %call102 = tail call double @sin(double noundef %75) #15, !dbg !345
...
sw.bb7:                                           ; preds = %if.else
  call void @llvm.dbg.value(metadata double** %neww, metadata !122, metadata !DIExpression()) #15, !dbg !395
  call void @llvm.dbg.value(metadata double** %old, metadata !123, metadata !DIExpression()) #15, !dbg !395
  call void @llvm.dbg.value(metadata i32 %lb, metadata !124, metadata !DIExpression()) #15, !dbg !395
  call void @llvm.dbg.value(metadata i32 %ub, metadata !125, metadata !DIExpression()) #15, !dbg !395
  call void @llvm.dbg.value(metadata i32 %lb, metadata !126, metadata !DIExpression()) #15, !dbg !395
  %idx.ext.i = sext i32 %lb to i64, !dbg !397
  call void @llvm.dbg.value(metadata !DIArgList(double** %old, i64 %idx.ext.i), metadata !128, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 8, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #15, !dbg !395
  call void @llvm.dbg.value(metadata !DIArgList(double** %neww, i64 %idx.ext.i), metadata !127, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 8, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #15, !dbg !395
  call void @llvm.dbg.value(metadata !DIArgList(double** %old, i64 %idx.ext.i), metadata !128, metadata !DIExpression(DW_OP_LLVM_arg, 0, DW_OP_LLVM_arg, 1, DW_OP_constu, 8, DW_OP_mul, DW_OP_plus, DW_OP_stack_value)) #15, !dbg !395
  call void @llvm.dbg.value(metadata i32 %lb, metadata !126, metadata !DIExpression()) #15, !dbg !395
...
for.body.lr.ph.i:                                 ; preds = %sw.bb7
  ...
  call void @llvm.dbg.value(metadata double** %add.ptr2.i, metadata !127, metadata !DIExpression()) #15, !dbg !395
  %add.ptr.i = getelementptr inbounds double*, double** %old, i64 %idx.ext.i, !dbg !397
  call void @llvm.dbg.value(metadata double** %add.ptr.i, metadata !128, metadata !DIExpression()) #15, !dbg !395
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  call void @llvm.dbg.value(metadata double** %rol.018.i, metadata !128, metadata !DIExpression()) #15, !dbg !395
  call void @llvm.dbg.value(metadata double** %rne.017.i, metadata !127, metadata !DIExpression()) #15, !dbg !395
  call void @llvm.dbg.value(metadata i32 %j.016.i, metadata !126, metadata !DIExpression()) #15, !dbg !395
  %call.i = tail call noalias i8* @malloc(i64 noundef %mul.i) #15, !dbg !401
  %3 = bitcast double** %rol.018.i to i8**, !dbg !402
  store i8* %call.i, i8** %3, align 8, !dbg !402, !tbaa !141
  %call5.i = tail call noalias i8* @malloc(i64 noundef %mul.i) #15, !dbg !403
  ...
  call void @llvm.dbg.value(metadata i32 %inc.i, metadata !126, metadata !DIExpression()) #15, !dbg !395
  %incdec.ptr.i = getelementptr inbounds double*, double** %rol.018.i, i64 1, !dbg !406
  call void @llvm.dbg.value(metadata double** %incdec.ptr.i, metadata !128, metadata !DIExpression()) #15, !dbg !395
  %incdec.ptr6.i = getelementptr inbounds double*, double** %rne.017.i, i64 1, !dbg !407
  call void @llvm.dbg.value(metadata double** %incdec.ptr6.i, metadata !127, metadata !DIExpression()) #15, !dbg !395
...
return:                                           ; preds = %sw.bb8, %for.body.i, %sw.bb7, %if.else6, %if.then5, %if.else, %sync.continue
...
entry:
  ...
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str, i64 0, i64 0), i64 43, i64 1, %struct._IO_FILE* %0) #16, !dbg !452
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !453, !tbaa !141
  %3 = tail call i64 @fwrite(i8* getelementptr inbounds ([72 x i8], [72 x i8]* @.str.1, i64 0, i64 0), i64 71, i64 1, %struct._IO_FILE* %2) #16, !dbg !454
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !455, !tbaa !141
  %5 = tail call i64 @fwrite(i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.2, i64 0, i64 0), i64 70, i64 1, %struct._IO_FILE* %4) #16, !dbg !456
  %6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !457, !tbaa !141
  %7 = tail call i64 @fwrite(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.3, i64 0, i64 0), i64 41, i64 1, %struct._IO_FILE* %6) #16, !dbg !458
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !459, !tbaa !141
  %9 = tail call i64 @fwrite(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i64 0, i64 0), i64 21, i64 1, %struct._IO_FILE* %8) #16, !dbg !460
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !461, !tbaa !141
  %11 = tail call i64 @fwrite(i8* getelementptr inbounds ([62 x i8], [62 x i8]* @.str.5, i64 0, i64 0), i64 61, i64 1, %struct._IO_FILE* %10) #16, !dbg !462
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !463, !tbaa !141
  %13 = tail call i64 @fwrite(i8* getelementptr inbounds ([64 x i8], [64 x i8]* @.str.6, i64 0, i64 0), i64 63, i64 1, %struct._IO_FILE* %12) #16, !dbg !464
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !465, !tbaa !141
  %15 = tail call i64 @fwrite(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.7, i64 0, i64 0), i64 62, i64 1, %struct._IO_FILE* %14) #16, !dbg !466
  %16 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !467, !tbaa !141
  %17 = tail call i64 @fwrite(i8* getelementptr inbounds ([63 x i8], [63 x i8]* @.str.8, i64 0, i64 0), i64 62, i64 1, %struct._IO_FILE* %16) #16, !dbg !468
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !469, !tbaa !141
  %19 = tail call i64 @fwrite(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.9, i64 0, i64 0), i64 49, i64 1, %struct._IO_FILE* %18) #16, !dbg !470
  %20 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !471, !tbaa !141
  %21 = tail call i64 @fwrite(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.10, i64 0, i64 0), i64 32, i64 1, %struct._IO_FILE* %20) #16, !dbg !472
  ret i32 1, !dbg !473
}
...
if.then:                                          ; preds = %entry
  ...
  tail call void @exit(i32 noundef 0) #17, !dbg !546
  unreachable, !dbg !546

if.end:                                           ; preds = %entry
  %call2 = tail call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* noundef nonnull %call, i8* noundef getelementptr inbounds ([33 x i8], [33 x i8]* @.str.13, i64 0, i64 0), i32* noundef nonnull @nx, i32* noundef nonnull @ny, i32* noundef nonnull @nt, double* noundef nonnull @xu, double* noundef nonnull @xo, double* noundef nonnull @yu, double* noundef nonnull @yo, double* noundef nonnull @tu, double* noundef nonnull @to) #15, !dbg !547
...
if.then4:                                         ; preds = %if.end
  %call5 = tail call i32* @__errno_location() #18, !dbg !551
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #15, !dbg !581
  %1 = bitcast i32* %help to i8*, !dbg !581
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1) #15, !dbg !581
  %2 = bitcast i32* %round to i8*, !dbg !581
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %2) #15, !dbg !581
  %3 = getelementptr inbounds [100 x i8], [100 x i8]* %filename, i64 0, i64 0, !dbg !582
  call void @llvm.lifetime.start.p0i8(i64 100, i8* nonnull %3) #15, !dbg !582
  ...
  %call4 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %4, i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.29, i64 0, i64 0), double noundef 0x2DAC0552ED6FE79F) #16, !dbg !598
  ...
  call void (i32, i8**, i8**, i32*, ...) @get_options(i32 noundef %argc, i8** noundef %argv, i8** noundef getelementptr inbounds ([15 x i8*], [15 x i8*]* @specifiers, i64 0, i64 0), i32* noundef getelementptr inbounds ([15 x i32], [15 x i32]* @opt_types, i64 0, i64 0), i32* noundef nonnull @leafmaxcol, i32* noundef nonnull @nx, i32* noundef nonnull @ny, i32* noundef nonnull @nt, double* noundef nonnull @xu, double* noundef nonnull @xo, double* noundef nonnull @yu, double* noundef nonnull @yo, double* noundef nonnull @tu, double* noundef nonnull @to, i8* noundef nonnull %3, i32* noundef nonnull %benchmark, i32* noundef nonnull %help, i32* noundef nonnull %round) #15, !dbg !599
...
if.end13:                                         ; preds = %sw.bb11, %sw.bb9, %sw.bb, %if.end
...
if.end19:                                         ; preds = %if.then17, %for.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %8) #15, !dbg !683
  call void @llvm.dbg.declare(metadata %struct.timeval* %t1, metadata !575, metadata !DIExpression()), !dbg !684
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %9) #15, !dbg !683
  call void @llvm.dbg.declare(metadata %struct.timeval* %t2, metadata !578, metadata !DIExpression()), !dbg !685
  %call33 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #15, !dbg !686
  %call34 = call i32 @heat(), !dbg !687
  call void @llvm.dbg.value(metadata i32 0, metadata !565, metadata !DIExpression()), !dbg !580
  %call35 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #15, !dbg !688
  ...
  %25 = call i64 @fwrite(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.31, i64 0, i64 0), i64 20, i64 1, %struct._IO_FILE* %24) #16, !dbg !705
  %26 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !706, !tbaa !141
  %27 = load double, double* @dx, align 8, !dbg !707, !tbaa !100
  %call44 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %26, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.32, i64 0, i64 0), double noundef %27) #16, !dbg !708
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !709, !tbaa !141
  %29 = load double, double* @dy, align 8, !dbg !710, !tbaa !100
  %call45 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %28, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.33, i64 0, i64 0), double noundef %29) #16, !dbg !711
  %30 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !712, !tbaa !141
  %31 = load double, double* @dt, align 8, !dbg !713, !tbaa !100
  %call46 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %30, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.34, i64 0, i64 0), double noundef %31) #16, !dbg !714
  ...
  %call52 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %32, i8* noundef getelementptr inbounds ([58 x i8], [58 x i8]* @.str.35, i64 0, i64 0), double noundef %sub51) #16, !dbg !723
  ...
  %call53 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %43, i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.36, i64 0, i64 0), i32 noundef %44) #16, !dbg !726
  %45 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !727, !tbaa !141
  %46 = load i32, i32* @nx, align 4, !dbg !728, !tbaa !136
  %call54 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %45, i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.37, i64 0, i64 0), i32 noundef %46) #16, !dbg !729
  %47 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !730, !tbaa !141
  %48 = load i32, i32* @ny, align 4, !dbg !731, !tbaa !136
  %call55 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %47, i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.38, i64 0, i64 0), i32 noundef %48) #16, !dbg !732
  %49 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !733, !tbaa !141
  %50 = load i32, i32* @nt, align 4, !dbg !734, !tbaa !136
  %call56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %49, i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.39, i64 0, i64 0), i32 noundef %50) #16, !dbg !735
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %9) #15, !dbg !736
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %8) #15, !dbg !736
...
cleanup:                                          ; preds = %if.end19, %if.end13, %if.then
  ...
  call void @llvm.lifetime.end.p0i8(i64 100, i8* nonnull %3) #15, !dbg !740
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #15, !dbg !740
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1) #15, !dbg !740
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #15, !dbg !740
