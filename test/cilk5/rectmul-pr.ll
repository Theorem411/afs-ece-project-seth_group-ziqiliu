...
pfor.body.entry:                                  ; preds = %pfor.cond
  ...
  %call = tail call double @sin(double noundef %g.0.g.0.g.0.) #19, !dbg !80
  call void @llvm.dbg.value(metadata double %g.0.g.0.g.0., metadata !61, metadata !DIExpression()), !dbg !69
...
if.end.peel:                                      ; preds = %entry
  ...
  %call.peel = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i32 noundef 0, double noundef %0, double noundef %v) #20, !dbg !361
...
if.end.peel:                                      ; preds = %entry
  ...
  %call.peel = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %2, i8* noundef getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i64 0, i64 0), i32 noundef 0, double noundef %0, double noundef %1, i32 noundef 0) #20, !dbg !388
...
if.then:                                          ; preds = %entry
  call void @llvm.dbg.value(metadata [256 x double]* %R, metadata !345, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata double %v, metadata !346, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i32 0, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i32 0, metadata !347, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i32 0, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i64 0, metadata !347, metadata !DIExpression()) #19, !dbg !420
...
if.end.peel.i:                                    ; preds = %if.then
  ...
  %call.peel.i = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i32 noundef 0, double noundef %0, double noundef %v) #21, !dbg !426
  call void @llvm.dbg.value(metadata i32 1, metadata !348, metadata !DIExpression()) #19, !dbg !420
  br label %vector.ph, !dbg !427

vector.ph:                                        ; preds = %if.end.peel.i, %if.then
  %error.1.peel.i = phi i32 [ 1, %if.end.peel.i ], [ 0, %if.then ], !dbg !420
  call void @llvm.dbg.value(metadata i32 %error.1.peel.i, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i64 1, metadata !347, metadata !DIExpression()) #19, !dbg !420
...
for.body.i:                                       ; preds = %vector.body
  ...
  call void @llvm.dbg.value(metadata i32 %24, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i64 253, metadata !347, metadata !DIExpression()) #19, !dbg !420
  ...
  call void @llvm.dbg.value(metadata i32 %error.1.i, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i64 254, metadata !347, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i32 %error.1.i, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i64 254, metadata !347, metadata !DIExpression()) #19, !dbg !420
  ...
  call void @llvm.dbg.value(metadata i32 %error.1.i.1, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i64 255, metadata !347, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i32 %error.1.i.1, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i64 255, metadata !347, metadata !DIExpression()) #19, !dbg !420
  ...
  call void @llvm.dbg.value(metadata i32 %error.1.i.2, metadata !348, metadata !DIExpression()) #19, !dbg !420
  call void @llvm.dbg.value(metadata i64 256, metadata !347, metadata !DIExpression()) #19, !dbg !420
...
cleanup:                                          ; preds = %if.end18, %for.body.i
...
return:                                           ; preds = %if.end13, %vector.ph
  ret void, !dbg !523
}
...
entry:
  ...
  %call = tail call noalias i8* @malloc(i64 noundef %mul1) #19, !dbg !564
  ...
  %call4 = tail call noalias i8* @malloc(i64 noundef %mul3) #19, !dbg !568
  ...
  %call7 = tail call noalias i8* @malloc(i64 noundef %mul6) #19, !dbg !571
...
for.cond.cleanup:                                 ; preds = %if.end32, %entry
  tail call void @free(i8* noundef %call) #19, !dbg !576
  tail call void @free(i8* noundef %call4) #19, !dbg !577
  tail call void @free(i8* noundef %call7) #19, !dbg !578
  ret i32 0, !dbg !579

for.body.tf:                                      ; preds = %if.end32, %for.body.tf.lr.ph
...
det.cont.tf:                                      ; preds = %det.achd, %for.body.tf
...
sync.continue:                                    ; preds = %det.cont9
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %3) #19, !dbg !584
  call void @llvm.dbg.declare(metadata %struct.timeval* %t1, metadata !555, metadata !DIExpression()), !dbg !585
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %4) #19, !dbg !584
  call void @llvm.dbg.declare(metadata %struct.timeval* %t2, metadata !558, metadata !DIExpression()), !dbg !586
  %call10 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #19, !dbg !587
  ...
  %call12 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #19, !dbg !589
...
if.else:                                          ; preds = %if.end, %sync.continue
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !616, !tbaa !359
  %10 = tail call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.6, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %9) #20, !dbg !618
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !619, !tbaa !359
  %call27 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %11, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i64 0, i64 0), i64 noundef %mul26) #20, !dbg !620
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !621, !tbaa !359
  %call29 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %12, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.8, i64 0, i64 0), i64 noundef %mul18) #20, !dbg !622
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !623, !tbaa !359
  %call31 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %13, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.9, i64 0, i64 0), i64 noundef %mul30) #20, !dbg !624
  br label %if.end32

if.end32:                                         ; preds = %if.else, %if.then22
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %4) #19, !dbg !625
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %3) #19, !dbg !625
...
if.end45:                                         ; preds = %det.cont36, %if.then21, %det.cont
...
return:                                           ; preds = %sync.continue, %if.else, %if.then3
...
entry:
  ...
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.10, i64 0, i64 0), i64 70, i64 1, %struct._IO_FILE* %0) #20, !dbg !726
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !727, !tbaa !359
  %3 = tail call i64 @fwrite(i8* getelementptr inbounds ([92 x i8], [92 x i8]* @.str.11, i64 0, i64 0), i64 91, i64 1, %struct._IO_FILE* %2) #20, !dbg !728
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !729, !tbaa !359
  %5 = tail call i64 @fwrite(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.12, i64 0, i64 0), i64 45, i64 1, %struct._IO_FILE* %4) #20, !dbg !730
  %6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !731, !tbaa !359
  %7 = tail call i64 @fwrite(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), i64 9, i64 1, %struct._IO_FILE* %6) #20, !dbg !732
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !733, !tbaa !359
  %9 = tail call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.14, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %8) #20, !dbg !734
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !735, !tbaa !359
  %11 = tail call i64 @fwrite(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.15, i64 0, i64 0), i64 34, i64 1, %struct._IO_FILE* %10) #20, !dbg !736
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !737, !tbaa !359
  %13 = tail call i64 @fwrite(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.16, i64 0, i64 0), i64 45, i64 1, %struct._IO_FILE* %12) #20, !dbg !738
  ret i32 1, !dbg !739
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #19, !dbg !757
  %1 = bitcast i32* %y to i8*, !dbg !757
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1) #19, !dbg !757
  %2 = bitcast i32* %z to i8*, !dbg !757
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %2) #19, !dbg !757
  %3 = bitcast i32* %benchmark to i8*, !dbg !757
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #19, !dbg !757
  %4 = bitcast i32* %help to i8*, !dbg !757
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #19, !dbg !757
  %5 = bitcast i32* %check to i8*, !dbg !757
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #19, !dbg !757
  %6 = bitcast i32* %round to i8*, !dbg !757
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %6) #19, !dbg !757
  ...
  call void (i32, i8**, i8**, i32*, ...) @get_options(i32 noundef %argc, i8** noundef %argv, i8** noundef getelementptr inbounds ([8 x i8*], [8 x i8*]* @specifiers, i64 0, i64 0), i32* noundef getelementptr inbounds ([8 x i32], [8 x i32]* @opt_types, i64 0, i64 0), i32* noundef nonnull %x, i32* noundef nonnull %y, i32* noundef nonnull %z, i32* noundef nonnull %check, i32* noundef nonnull %benchmark, i32* noundef nonnull %help, i32* noundef nonnull %round) #19, !dbg !763
...
if.then:                                          ; preds = %entry
  ...
  %9 = call i64 @fwrite(i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.10, i64 0, i64 0), i64 70, i64 1, %struct._IO_FILE* %8) #21, !dbg !769
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !770, !tbaa !359
  %11 = call i64 @fwrite(i8* getelementptr inbounds ([92 x i8], [92 x i8]* @.str.11, i64 0, i64 0), i64 91, i64 1, %struct._IO_FILE* %10) #21, !dbg !771
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !772, !tbaa !359
  %13 = call i64 @fwrite(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.12, i64 0, i64 0), i64 45, i64 1, %struct._IO_FILE* %12) #21, !dbg !773
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !774, !tbaa !359
  %15 = call i64 @fwrite(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), i64 9, i64 1, %struct._IO_FILE* %14) #21, !dbg !775
  %16 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !776, !tbaa !359
  %17 = call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.14, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %16) #21, !dbg !777
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !778, !tbaa !359
  %19 = call i64 @fwrite(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.15, i64 0, i64 0), i64 34, i64 1, %struct._IO_FILE* %18) #21, !dbg !779
  %20 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !780, !tbaa !359
  %21 = call i64 @fwrite(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.16, i64 0, i64 0), i64 45, i64 1, %struct._IO_FILE* %20) #21, !dbg !781
...
cleanup:                                          ; preds = %if.end15, %if.then
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %6) #19, !dbg !817
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #19, !dbg !817
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #19, !dbg !817
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #19, !dbg !817
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #19, !dbg !817
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1) #19, !dbg !817
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #19, !dbg !817
...
declare i32 @llvm.vector.reduce.add.v2i32(<2 x i32>) #18
