...
cleanup54:                                        ; preds = %for.cond.cleanup11, %if.then, %det_cont, %for.cond.cleanup28
  ret void, !dbg !230
}
...
if.then:                                          ; preds = %entry
  ...
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([66 x i8], [66 x i8]* @.str, i64 0, i64 0), i64 65, i64 1, %struct._IO_FILE* %0) #18, !dbg !281
  tail call void @exit(i32 noundef 1) #19, !dbg !282
  unreachable, !dbg !282
...
for.body21:                                       ; preds = %for.cond.cleanup, %for.cond17
...
cond.false:                                       ; preds = %for.body21
  tail call void @__assert_fail(i8* noundef getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i64 0, i64 0), i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0), i32 noundef 471, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #19, !dbg !345
  unreachable, !dbg !345
}
