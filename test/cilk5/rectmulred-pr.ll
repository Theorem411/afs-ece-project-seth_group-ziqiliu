...
if.end.peel:                                      ; preds = %entry
  ...
  %call.peel = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i32 noundef 0, double noundef %0, double noundef %v) #17, !dbg !332
...
if.end.peel:                                      ; preds = %entry
  ...
  %call.peel = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %2, i8* noundef getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i64 0, i64 0), i32 noundef 0, double noundef %0, double noundef %1, i32 noundef 0) #17, !dbg !357
...
if.then:                                          ; preds = %det.cont8, %det.cont, %entry
  %R.tr.lcssa = phi [256 x double]* [ %R, %entry ], [ %add.ptr10, %det.cont8 ], [ %add.ptr, %det.cont ]
  call void @llvm.dbg.value(metadata [256 x double]* %R.tr.lcssa, metadata !315, metadata !DIExpression()) #18, !dbg !385
  call void @llvm.dbg.value(metadata double %v, metadata !316, metadata !DIExpression()) #18, !dbg !385
  call void @llvm.dbg.value(metadata i32* %errorf, metadata !317, metadata !DIExpression()) #18, !dbg !385
  call void @llvm.dbg.value(metadata i32 0, metadata !319, metadata !DIExpression()) #18, !dbg !385
  call void @llvm.dbg.value(metadata i64 0, metadata !318, metadata !DIExpression()) #18, !dbg !385
...
if.end.peel.i:                                    ; preds = %if.then
  ...
  %call.peel.i = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i32 noundef 0, double noundef %0, double noundef %v) #19, !dbg !392
  call void @llvm.dbg.value(metadata i32 1, metadata !319, metadata !DIExpression()) #18, !dbg !385
...
if.end:                                           ; preds = %det.cont8, %if.end.lr.ph
...
sync.continue:                                    ; preds = %if.end18, %for.body.i
  ret void, !dbg !504
}
...
if.end39:                                         ; preds = %det.cont31, %if.then19, %det.cont
  sync within %syncreg, label %sync.continue, !dbg !619

sync.continue:                                    ; preds = %if.end39, %if.else, %if.then3
  ret void, !dbg !620
}
...
entry:
  ...
  %call = tail call noalias i8* @malloc(i64 noundef %mul1) #18, !dbg !638
  ...
  %call4 = tail call noalias i8* @malloc(i64 noundef %mul3) #18, !dbg !642
  ...
  %call7 = tail call noalias i8* @malloc(i64 noundef %mul6) #18, !dbg !645
...
det.cont.tf:                                      ; preds = %det.achd, %entry
...
sync.continue:                                    ; preds = %det.cont9
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %3) #18, !dbg !651
  ...
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %4) #18, !dbg !651
  call void @llvm.dbg.declare(metadata %struct.timeval* %t2, metadata !633, metadata !DIExpression()), !dbg !653
  %call10 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #18, !dbg !654
  ...
  %call11 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #18, !dbg !656
...
if.else:                                          ; preds = %if.end, %sync.continue.if.else_crit_edge
  ...
  %11 = call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.6, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %10) #17, !dbg !691
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !692, !tbaa !330
  %mul24 = shl nsw i64 %x, 4, !dbg !693
  %call25 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %12, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i64 0, i64 0), i64 noundef %mul24) #17, !dbg !694
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !695, !tbaa !330
  %call27 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %13, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.8, i64 0, i64 0), i64 noundef %mul26.pre-phi) #17, !dbg !696
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !697, !tbaa !330
  %mul28 = shl nsw i64 %z, 4, !dbg !698
  %call29 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %14, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.9, i64 0, i64 0), i64 noundef %mul28) #17, !dbg !699
  br label %if.end30

if.end30:                                         ; preds = %if.else, %if.then20
  call void @free(i8* noundef %call) #18, !dbg !700
  call void @free(i8* noundef %call4) #18, !dbg !701
  call void @free(i8* noundef %call7) #18, !dbg !702
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %4) #18, !dbg !703
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %3) #18, !dbg !703
  ret i32 0, !dbg !704
}
...
entry:
  ...
  %1 = tail call i64 @fwrite(i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.10, i64 0, i64 0), i64 70, i64 1, %struct._IO_FILE* %0) #17, !dbg !722
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !723, !tbaa !330
  %3 = tail call i64 @fwrite(i8* getelementptr inbounds ([92 x i8], [92 x i8]* @.str.11, i64 0, i64 0), i64 91, i64 1, %struct._IO_FILE* %2) #17, !dbg !724
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !725, !tbaa !330
  %5 = tail call i64 @fwrite(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.12, i64 0, i64 0), i64 45, i64 1, %struct._IO_FILE* %4) #17, !dbg !726
  %6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !727, !tbaa !330
  %7 = tail call i64 @fwrite(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), i64 9, i64 1, %struct._IO_FILE* %6) #17, !dbg !728
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !729, !tbaa !330
  %9 = tail call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.14, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %8) #17, !dbg !730
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !731, !tbaa !330
  %11 = tail call i64 @fwrite(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.15, i64 0, i64 0), i64 34, i64 1, %struct._IO_FILE* %10) #17, !dbg !732
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !733, !tbaa !330
  %13 = tail call i64 @fwrite(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.16, i64 0, i64 0), i64 45, i64 1, %struct._IO_FILE* %12) #17, !dbg !734
  ret i32 1, !dbg !735
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #18, !dbg !752
  %1 = bitcast i32* %y to i8*, !dbg !752
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1) #18, !dbg !752
  %2 = bitcast i32* %z to i8*, !dbg !752
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %2) #18, !dbg !752
  %3 = bitcast i32* %benchmark to i8*, !dbg !752
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #18, !dbg !752
  %4 = bitcast i32* %help to i8*, !dbg !752
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #18, !dbg !752
  %5 = bitcast i32* %check to i8*, !dbg !752
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #18, !dbg !752
  ...
  call void (i32, i8**, i8**, i32*, ...) @get_options(i32 noundef %argc, i8** noundef %argv, i8** noundef getelementptr inbounds ([7 x i8*], [7 x i8*]* @specifiers, i64 0, i64 0), i32* noundef getelementptr inbounds ([7 x i32], [7 x i32]* @opt_types, i64 0, i64 0), i32* noundef nonnull %x, i32* noundef nonnull %y, i32* noundef nonnull %z, i32* noundef nonnull %check, i32* noundef nonnull %benchmark, i32* noundef nonnull %help) #18, !dbg !757
...
if.then:                                          ; preds = %entry
  ...
  %8 = call i64 @fwrite(i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.10, i64 0, i64 0), i64 70, i64 1, %struct._IO_FILE* %7) #19, !dbg !763
  %9 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !764, !tbaa !330
  %10 = call i64 @fwrite(i8* getelementptr inbounds ([92 x i8], [92 x i8]* @.str.11, i64 0, i64 0), i64 91, i64 1, %struct._IO_FILE* %9) #19, !dbg !765
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !766, !tbaa !330
  %12 = call i64 @fwrite(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.12, i64 0, i64 0), i64 45, i64 1, %struct._IO_FILE* %11) #19, !dbg !767
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !768, !tbaa !330
  %14 = call i64 @fwrite(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.13, i64 0, i64 0), i64 9, i64 1, %struct._IO_FILE* %13) #19, !dbg !769
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !770, !tbaa !330
  %16 = call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.14, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %15) #19, !dbg !771
  %17 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !772, !tbaa !330
  %18 = call i64 @fwrite(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.15, i64 0, i64 0), i64 34, i64 1, %struct._IO_FILE* %17) #19, !dbg !773
  %19 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !774, !tbaa !330
  %20 = call i64 @fwrite(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.16, i64 0, i64 0), i64 45, i64 1, %struct._IO_FILE* %19) #19, !dbg !775
...
cleanup:                                          ; preds = %if.end15, %if.then
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #18, !dbg !810
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #18, !dbg !810
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #18, !dbg !810
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #18, !dbg !810
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1) #18, !dbg !810
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #18, !dbg !810
