...
pfor.body.entry:                                  ; preds = %pfor.cond
  ...
  %call = tail call double @sin(double noundef %g.0.g.0.g.0.) #21, !dbg !79
  call void @llvm.dbg.value(metadata double %g.0.g.0.g.0., metadata !60, metadata !DIExpression()), !dbg !68
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc5_crit_edge.us, %for.cond1.preheader.us.preheader
...
for.cond1.for.inc5_crit_edge.us:                  ; preds = %for.body3.us.epil, %for.cond1.for.inc5_crit_edge.us.unr-lcssa
...
for.cond1.preheader.us:                           ; preds = %for.cond1.for.inc18_crit_edge.us, %for.cond1.preheader.us.preheader
...
if.end.lr.ph.lr.ph:                               ; preds = %det.cont, %entry
...
if.end.lr.ph:                                     ; preds = %if.else, %if.end.lr.ph.lr.ph
...
for.cond.preheader:                               ; preds = %det.cont44, %if.else, %det.cont, %entry
...
for.cond3.preheader.us.us:                        ; preds = %for.cond3.for.inc23_crit_edge.split.us.us.us, %for.cond3.preheader.us.us.preheader
...
for.body8.us.us.us:                               ; preds = %for.body8.us.us.us, %for.cond6.preheader.us.us.us
...
for.cond6.for.end_crit_edge.us.us.us:             ; preds = %for.body8.us.us.us.epil, %for.cond6.for.end_crit_edge.us.us.us.unr-lcssa
...
for.cond3.preheader.us:                           ; preds = %for.cond3.for.inc23_crit_edge.split.us208, %for.cond3.preheader.us.preheader
...
for.cond6.preheader.us200.preheader:              ; preds = %middle.block, %for.cond3.preheader.us
  %indvars.iv.ph = phi i64 [ 0, %for.cond3.preheader.us ], [ %n.vec, %middle.block ]
  br label %for.cond6.preheader.us200, !dbg !430

for.cond6.preheader.us200:                        ; preds = %for.cond6.preheader.us200, %for.cond6.preheader.us200.preheader
...
if.end:                                           ; preds = %det.cont44, %if.end.lr.ph
...
if.end.lr.ph:                                     ; preds = %det.cont, %entry
...
for.cond.preheader:                               ; preds = %det.cont43, %det.cont, %entry
...
for.cond3.preheader.us.us:                        ; preds = %for.cond3.for.inc22_crit_edge.split.us.us.us, %for.cond3.preheader.us.us.preheader
...
if.end:                                           ; preds = %det.cont43, %if.end.lr.ph
...
for.cond3.preheader.us.epil:                      ; preds = %for.cond3.preheader.us.epil, %return.loopexit255.unr-lcssa
...
return:                                           ; preds = %for.cond3.preheader.us.epil, %return.loopexit255.unr-lcssa, %for.cond3.for.inc22_crit_edge.split.us.us.us, %for.cond.preheader
  sync within %syncreg, label %common.ret, !dbg !559
}
...
if.else39.lr.ph:                                  ; preds = %if.else45, %entry
...
for.cond4.preheader.preheader249:                 ; preds = %middle.block, %for.cond4.preheader.preheader
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader, %for.cond4.preheader.preheader249
...
if.else39:                                        ; preds = %if.then41, %if.else39.lr.ph
...
if.end53:                                         ; preds = %for.cond4.preheader, %for.cond21.for.end33_crit_edge.us, %for.cond21.preheader.preheader, %for.cond17.preheader, %for.cond4.for.end_crit_edge.us, %middle.block, %for.cond.preheader
  ret void, !dbg !631
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %0) #21, !dbg !691
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %1) #21, !dbg !695
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %2) #21, !dbg !695
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #21, !dbg !695
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #21, !dbg !699
  ...
  call void (i32, i8**, i8**, i32*, ...) @get_options(i32 noundef %argc, i8** noundef %argv, i8** noundef getelementptr inbounds ([6 x i8*], [6 x i8*]* @specifiers, i64 0, i64 0), i32* noundef getelementptr inbounds ([6 x i32], [6 x i32]* @opt_types, i64 0, i64 0), i32* noundef nonnull %n, i32* noundef nonnull %check, i32* noundef nonnull %rand_check, i32* noundef nonnull %help, i32* noundef nonnull %round) #21, !dbg !701
...
if.then:                                          ; preds = %entry
  ...
  %7 = call i64 @fwrite(i8* getelementptr inbounds ([58 x i8], [58 x i8]* @.str.7, i64 0, i64 0), i64 57, i64 1, %struct._IO_FILE* %6) #22, !dbg !709
  %8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !710, !tbaa !707
  %9 = call i64 @fwrite(i8* getelementptr inbounds ([70 x i8], [70 x i8]* @.str.8, i64 0, i64 0), i64 69, i64 1, %struct._IO_FILE* %8) #22, !dbg !711
  %10 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !712, !tbaa !707
  %11 = call i64 @fwrite(i8* getelementptr inbounds ([80 x i8], [80 x i8]* @.str.9, i64 0, i64 0), i64 79, i64 1, %struct._IO_FILE* %10) #22, !dbg !713
  call void @exit(i32 noundef 1) #23, !dbg !714
  unreachable, !dbg !714
...
for.cond.cleanup:                                 ; preds = %if.end59, %if.end
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #21, !dbg !720
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #21, !dbg !720
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #21, !dbg !720
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %1) #21, !dbg !720
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %0) #21, !dbg !720
  ret i32 0, !dbg !721
...
for.body:                                         ; preds = %if.end59, %for.body.lr.ph
  ...
  %call4 = call noalias i8* @malloc(i64 noundef %mul3) #21, !dbg !725
  ...
  %call8 = call noalias i8* @malloc(i64 noundef %mul3) #21, !dbg !727
  ...
  %call12 = call noalias i8* @malloc(i64 noundef %mul3) #21, !dbg !729
...
if.then14:                                        ; preds = %for.body
  ...
  %call17 = call noalias i8* @malloc(i64 noundef %mul16) #21, !dbg !737
  ...
  %call20 = call noalias i8* @malloc(i64 noundef %mul16) #21, !dbg !739
  ...
  %call23 = call noalias i8* @malloc(i64 noundef %mul16) #21, !dbg !741
...
for.cond.for.end_crit_edge.i:                     ; preds = %for.body.i.epil, %for.cond.for.end_crit_edge.i.unr-lcssa
...
if.then25:                                        ; preds = %if.else
  call void @llvm.dbg.value(metadata i32 %15, metadata !670, metadata !DIExpression()), !dbg !690
  %call29 = call noalias i8* @malloc(i64 noundef %mul3) #21, !dbg !763
  ...
  call void @llvm.dbg.value(metadata float* %28, metadata !254, metadata !DIExpression()) #21, !dbg !766
  call void @llvm.dbg.value(metadata i32 %15, metadata !255, metadata !DIExpression()) #21, !dbg !766
  call void @llvm.dbg.value(metadata i32 0, metadata !256, metadata !DIExpression()) #21, !dbg !766
...
if.end31.thread165:                               ; preds = %if.then25
  ...
  call void @llvm.memset.p0i8.i64(i8* align 4 %call29, i8 0, i64 %31, i1 false) #21, !dbg !770, !tbaa !117
  call void @llvm.dbg.value(metadata i32 undef, metadata !257, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)) #21, !dbg !766
  call void @llvm.dbg.value(metadata i32 undef, metadata !256, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_LLVM_convert, 64, DW_ATE_unsigned, DW_OP_LLVM_convert, 32, DW_ATE_unsigned, DW_OP_stack_value)) #21, !dbg !766
...
if.end31:                                         ; preds = %if.else, %for.cond.for.end_crit_edge.i
...
for.cond1.for.inc5_crit_edge.us.i:                ; preds = %for.body3.us.i.epil, %for.cond1.for.inc5_crit_edge.us.i.unr-lcssa
...
for.cond1.preheader.us.i106:                      ; preds = %for.cond1.for.inc5_crit_edge.us.i120, %for.cond1.preheader.us.i106.preheader
...
for.body3.us.i117:                                ; preds = %for.body3.us.i117, %for.cond1.preheader.us.i106
...
for.cond1.for.inc5_crit_edge.us.i120:             ; preds = %for.body3.us.i117.epil, %for.cond1.for.inc5_crit_edge.us.i120.unr-lcssa
...
init.exit122:                                     ; preds = %for.cond.for.end7_crit_edge.split.us.i121, %if.end31, %if.then25, %if.then14
  ...
  %50 = call i64 @fwrite(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.10, i64 0, i64 0), i64 58, i64 1, %struct._IO_FILE* %49) #22, !dbg !815
  ...
  call void @llvm.dbg.value(metadata float* %18, metadata !254, metadata !DIExpression()) #21, !dbg !817
  call void @llvm.dbg.value(metadata i32 %51, metadata !255, metadata !DIExpression()) #21, !dbg !817
  call void @llvm.dbg.value(metadata i32 0, metadata !256, metadata !DIExpression()) #21, !dbg !817
...
for.cond1.preheader.us.preheader.i124:            ; preds = %init.exit122
  ...
  call void @llvm.memset.p0i8.i64(i8* align 4 %call12, i8 0, i64 %54, i1 false) #21, !dbg !821, !tbaa !117
  call void @llvm.dbg.value(metadata i32 undef, metadata !257, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)) #21, !dbg !817
  call void @llvm.dbg.value(metadata i32 undef, metadata !256, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_LLVM_convert, 64, DW_ATE_unsigned, DW_OP_LLVM_convert, 32, DW_ATE_unsigned, DW_OP_stack_value)) #21, !dbg !817
  br label %zero.exit125, !dbg !822

zero.exit125:                                     ; preds = %for.cond1.preheader.us.preheader.i124, %init.exit122
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %13) #21, !dbg !823
  call void @llvm.dbg.declare(metadata %struct.timeval* %t1, metadata !685, metadata !DIExpression()), !dbg !824
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %14) #21, !dbg !823
  call void @llvm.dbg.declare(metadata %struct.timeval* %t2, metadata !688, metadata !DIExpression()), !dbg !825
  %call33 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t1, %struct.timezone* noundef null) #21, !dbg !826
  ...
  %call34 = call i32 @gettimeofday(%struct.timeval* noundef nonnull %t2, %struct.timezone* noundef null) #21, !dbg !829
...
if.then46:                                        ; preds = %if.else44
  ...
  call void @llvm.dbg.value(metadata float* %16, metadata !348, metadata !DIExpression()) #21, !dbg !877
  call void @llvm.dbg.value(metadata float* %17, metadata !349, metadata !DIExpression()) #21, !dbg !877
  call void @llvm.dbg.value(metadata float* undef, metadata !350, metadata !DIExpression()) #21, !dbg !877
  call void @llvm.dbg.value(metadata i32 %68, metadata !351, metadata !DIExpression()) #21, !dbg !877
  call void @llvm.dbg.value(metadata i32 0, metadata !352, metadata !DIExpression()) #21, !dbg !877
...
for.cond1.preheader.us.us.i:                      ; preds = %for.cond1.for.inc19_crit_edge.split.us.us.us.i, %for.cond1.preheader.us.us.preheader.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv69.i, metadata !352, metadata !DIExpression()) #21, !dbg !877
  call void @llvm.dbg.value(metadata i32 0, metadata !354, metadata !DIExpression()) #21, !dbg !877
...
for.cond4.preheader.us.us.us.i:                   ; preds = %for.cond4.for.end_crit_edge.us.us.us.i, %for.cond1.preheader.us.us.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv63.i, metadata !354, metadata !DIExpression()) #21, !dbg !877
  call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !355, metadata !DIExpression()) #21, !dbg !882
  call void @llvm.dbg.value(metadata i32 0, metadata !353, metadata !DIExpression()) #21, !dbg !877
...
for.body6.us.us.us.i:                             ; preds = %for.body6.us.us.us.i, %for.cond4.preheader.us.us.us.i
  ...
  call void @llvm.dbg.value(metadata float %c.043.us.us.us.i, metadata !355, metadata !DIExpression()) #21, !dbg !882
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i139, metadata !353, metadata !DIExpression()) #21, !dbg !877
  ...
  %77 = call float @llvm.fmuladd.f32(float %73, float %76, float %c.043.us.us.us.i) #21, !dbg !889
  call void @llvm.dbg.value(metadata float %77, metadata !355, metadata !DIExpression()) #21, !dbg !882
  %indvars.iv.next.i140 = or i64 %indvars.iv.i139, 1, !dbg !890
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i140, metadata !353, metadata !DIExpression()) #21, !dbg !877
  call void @llvm.dbg.value(metadata float %77, metadata !355, metadata !DIExpression()) #21, !dbg !882
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i140, metadata !353, metadata !DIExpression()) #21, !dbg !877
  ...
  %83 = call float @llvm.fmuladd.f32(float %79, float %82, float %77) #21, !dbg !889
  call void @llvm.dbg.value(metadata float %83, metadata !355, metadata !DIExpression()) #21, !dbg !882
  %indvars.iv.next.i140.1 = add nuw nsw i64 %indvars.iv.i139, 2, !dbg !890
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next.i140.1, metadata !353, metadata !DIExpression()) #21, !dbg !877
...
for.body6.us.us.us.i.epil:                        ; preds = %for.cond4.for.end_crit_edge.us.us.us.i.unr-lcssa
  call void @llvm.dbg.value(metadata float %c.043.us.us.us.i.unr, metadata !355, metadata !DIExpression()) #21, !dbg !882
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i139.unr, metadata !353, metadata !DIExpression()) #21, !dbg !877
  ...
  %89 = call float @llvm.fmuladd.f32(float %85, float %88, float %c.043.us.us.us.i.unr) #21, !dbg !889
  call void @llvm.dbg.value(metadata float %89, metadata !355, metadata !DIExpression()) #21, !dbg !882
  call void @llvm.dbg.value(metadata i64 %indvars.iv.i139.unr, metadata !353, metadata !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value)) #21, !dbg !877
...
for.cond4.for.end_crit_edge.us.us.us.i:           ; preds = %for.body6.us.us.us.i.epil, %for.cond4.for.end_crit_edge.us.us.us.i.unr-lcssa
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next64.i, metadata !354, metadata !DIExpression()) #21, !dbg !877
...
for.cond1.for.inc19_crit_edge.split.us.us.us.i:   ; preds = %for.cond4.for.end_crit_edge.us.us.us.i
  ...
  call void @llvm.dbg.value(metadata i64 %indvars.iv.next70.i, metadata !352, metadata !DIExpression()) #21, !dbg !877
...
for.cond1.preheader.us.i143:                      ; preds = %for.cond1.for.inc18_crit_edge.us.i, %for.cond1.for.inc19_crit_edge.split.us.us.us.i
...
if.end50.sink.split:                              ; preds = %for.cond1.for.inc18_crit_edge.us.i, %if.then46, %for.body.i138, %if.then41
  ...
  %call48 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %95, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.12, i64 0, i64 0), double noundef %error.0.lcssa.i.sink) #22, !dbg !926
...
if.end50:                                         ; preds = %if.end50.sink.split, %if.else44
  ...
  %97 = call i64 @fwrite(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.13, i64 0, i64 0), i64 22, i64 1, %struct._IO_FILE* %96) #22, !dbg !928
  ...
  %call52 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %98, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.14, i64 0, i64 0), i32 noundef %99) #22, !dbg !931
  call void @free(i8* noundef %call12) #21, !dbg !932
  call void @free(i8* noundef %call8) #21, !dbg !933
  call void @free(i8* noundef %call4) #21, !dbg !934
...
if.then54:                                        ; preds = %if.end50
  ...
  call void @free(i8* noundef %101) #21, !dbg !940
  %102 = bitcast float* %P1.1154184 to i8*, !dbg !941
  call void @free(i8* noundef %102) #21, !dbg !942
...
if.end59.sink.split:                              ; preds = %if.else55, %if.then54
  ...
  call void @free(i8* noundef %104) #21, !dbg !947
  br label %if.end59, !dbg !948

if.end59:                                         ; preds = %if.end59.sink.split, %if.else55
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %14) #21, !dbg !948
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %13) #21, !dbg !948
