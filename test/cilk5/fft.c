...
void test_speed(long size, int round) {
...
const char *specifiers[] = {"-n", "-c", "-benchmark", "-h", "-r", 0};
int opt_types[] = {LONGARG, BOOLARG, BENCHMARK, BOOLARG, INTARG, 0};

int main(int argc, char *argv[]) { 

  int correctness, help, benchmark, round;
  long size;
  ...
  get_options(argc, argv, specifiers, opt_types, &size, 
	      &correctness, &benchmark, &help, &round);
